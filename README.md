...
* Aggregator: The aggregator does not have much business logic, as the core functionality is delegated to the `IndexingTaskProcessor`, which is the standard implementation that the SDK provides.If you want to implement a custom task processor, you need to implement the `AggregatorProcessor` trait.
