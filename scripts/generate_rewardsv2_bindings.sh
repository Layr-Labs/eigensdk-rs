...
forge bind --alloy --use 0.8.27 --optimize --optimizer-runs 200 --skip-build --bindings-path $REWARDS_V2_SDK_BINDINGS_PATH --overwrite \
    --root $REWARDS_V2_SDK_CONTRACTS_LOCATION --module \
    $REWARDS_V2_SDK_CONTRACTS_ARGS

# Generate middleware bindings
forge bind --alloy --use 0.8.27 --optimize --optimizer-runs 200 --skip-build  --bindings-path $REWARDS_V2_MIDDLEWARE_BINDINGS_PATH --overwrite \
    --root $REWARDS_V2_MIDDLEWARE_CONTRACTS_LOCATION --module \
    $REWARDS_V2_MIDDLEWARE_CONTRACTS_ARGS

# Generate core bindings
forge bind --alloy --use 0.8.27 --optimize --optimizer-runs 200 --skip-build --bindings-path $REWARDS_V2_CORE_BINDINGS_PATH --overwrite \
