...
use incredible_dot_product::utils::setup_operator;
use tracing::info;
...
async fn main() {
    ...
    let avs = Address::from_str("0xcd8a1c3ba11cf5ecfa6267617243239504a98d90").unwrap();
    let registry_coordinator_address =
        Address::from_str("0xfd471836031dc5108809d173a067e8486b9047a3").unwrap();
    let operator_state_retriever_address =
        Address::from_str("0x5f3f1dbd7b74c6b46e8c44f98792a1daf8d69154").unwrap();
