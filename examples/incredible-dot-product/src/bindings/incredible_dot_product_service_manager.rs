...
```*/
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<incredibleDotProductTaskManagerCall>
            for UnderlyingRustTuple<'_> {
            ...
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>>
            for incredibleDotProductTaskManagerCall {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self
                }
            }
        }
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<incredibleDotProductTaskManagerReturn>
            for UnderlyingRustTuple<'_> {
            ...
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>>
            for incredibleDotProductTaskManagerReturn {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self { _0: tuple.0 }
                }
            }
...
```*/
                ...
                },
                {
                    ...
                    > {
                        <addPendingAdminCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                IncredibleDotProductServiceManagerCalls::addPendingAdmin,
                            )
                    }
                    addPendingAdmin
                },
                ...
                },
                {
                    ...
                    > {
                        <removeAppointeeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                IncredibleDotProductServiceManagerCalls::removeAppointee,
                            )
                    }
                    removeAppointee
                },
                ...
                },
                {
                    ...
                    > {
                        <rewardsInitiatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                IncredibleDotProductServiceManagerCalls::rewardsInitiator,
                            )
                    }
                    rewardsInitiator
                },
            ...
            ) -> alloy_sol_types::Result<IncredibleDotProductServiceManagerErrors>] = &[
                {
                    ...
                    > {
                        <OnlyStakeRegistry as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                IncredibleDotProductServiceManagerErrors::OnlyStakeRegistry,
                            )
                    }
                    OnlyStakeRegistry
                },
    ...
    for IncredibleDotProductServiceManagerEvents {
