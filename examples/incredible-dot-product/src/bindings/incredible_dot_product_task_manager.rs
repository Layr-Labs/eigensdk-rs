...
```*/
    ...
    pub struct DotProductInput {
        #[allow(missing_docs)]
        pub X: alloy::sol_types::private::Vec<
            alloy::sol_types::private::primitives::aliases::U256,
        >,
        #[allow(missing_docs)]
        pub Y: alloy::sol_types::private::Vec<
            alloy::sol_types::private::primitives::aliases::U256,
        >,
    }
    #[allow(
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolStruct for DotProductInput {
            ...
            fn eip712_root_type() -> alloy_sol_types::private::Cow<'static, str> {
                alloy_sol_types::private::Cow::Borrowed(
                    "DotProductInput(uint256[] X,uint256[] Y)",
                )
            }
            #[inline]
            fn eip712_components() -> alloy_sol_types::private::Vec<
...
```*/
    ...
    const _: () = {
        ...
        impl alloy_sol_types::private::SolTypeValue<Self> for Task {
            ...
            fn stv_to_tokens(&self) -> <Self as alloy_sol_types::SolType>::Token<'_> {
                (
                    <DotProductInput as alloy_sol_types::SolType>::tokenize(
        ...
        impl alloy_sol_types::SolStruct for Task {
            ...
            > {
                ...
                components
                    .push(
                        <DotProductInput as alloy_sol_types::SolStruct>::eip712_root_type(),
                    );
                components
                    .extend(
                        <DotProductInput as alloy_sol_types::SolStruct>::eip712_components(),
                    );
                components
            }
            #[inline]
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IIncredibleDotProductTaskManagerInstance<
        P,
        N = alloy_contract::private::Ethereum,
    > {
        address: alloy_sol_types::private::Address,
...
```*/
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolEvent for NewTaskCreated {
            ...
            const SIGNATURE: &'static str = "NewTaskCreated(uint32,((uint256[],uint256[]),uint32,bytes,uint32))";
            const SIGNATURE_HASH: alloy_sol_types::private::B256 = alloy_sol_types::private::B256::new([
                243u8, 208u8, 41u8, 134u8, 7u8, 203u8, 189u8, 227u8, 139u8, 171u8, 163u8,
                195u8, 145u8, 93u8, 39u8, 127u8, 31u8, 253u8, 128u8, 163u8, 132u8, 9u8,
                90u8, 2u8, 164u8, 164u8, 215u8, 192u8, 130u8, 174u8, 108u8, 217u8,
            ]);
            const ANONYMOUS: bool = false;
            #[allow(unused_variables)]
            #[inline]
        ...
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            impl ::core::convert::From<createNewTaskCall> for UnderlyingRustTuple<'_> {
                fn from(value: createNewTaskCall) -> Self {
                    (value.points, value.quorumThresholdPercentage, value.quorumNumbers)
                }
            }
            #[automatically_derived]
            #[doc(hidden)]
...
```*/
                ...
                },
                {
                    fn InvalidBLSSignature(
                        ...
                        <InvalidBLSSignature as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                IncredibleDotProductTaskManagerErrors::InvalidBLSSignature,
                            )
                    }
                    InvalidBLSSignature
                },
                ...
                },
                {
                    fn BitmapValueTooLarge(
                        ...
                        <BitmapValueTooLarge as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                IncredibleDotProductTaskManagerErrors::BitmapValueTooLarge,
                            )
                    }
                    BitmapValueTooLarge
                },
    ...
    for IncredibleDotProductTaskManagerEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IncredibleDotProductTaskManagerInstance<
        P,
        N = alloy_contract::private::Ethereum,
    > {
        address: alloy_sol_types::private::Address,
