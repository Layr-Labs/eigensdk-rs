...
set -a
source $root_dir/../../crates/operator_sets_contracts/anvil/utils.sh
...
start_anvil_docker "" $anvil_dir/incredible-dot-product-anvil-state
sleep 1

$root_dir/contracts/anvil/deploy-eigenlayer.sh
$root_dir/contracts/anvil/deploy-avs.sh
$root_dir/contracts/anvil/uam-permissions.sh
$root_dir/contracts/anvil/create-quorum.sh
