...
contract UAMPermissions is Script {
    using IncredibleRedisDeploymentLib for *;

    address internal deployer;
    IncredibleRedisDeploymentLib.DeploymentData deploymentData;
    CoreDeploymentLib.DeploymentData internal coreData;

    function setUp() public virtual {
        deployer = vm.rememberKey(vm.envUint("PRIVATE_KEY"));
        vm.label(deployer, "Deployer");
        deploymentData = IncredibleRedisDeploymentLib.readDeploymentJson(block.chainid);
    ...
    function run() external {
        ...
        IServiceManager serviceManager =
            IServiceManager(deploymentData.incredibleRedisServiceManager);
        ...
        _allocationManager.setAVSRegistrar(
            deploymentData.incredibleRedisServiceManager,
        ...
        _allocationManager.updateAVSMetadataURI(
            deploymentData.incredibleRedisServiceManager, "metadataURI"
        );
