...
library IncredibleRedisDeploymentLib {
    using stdJson for *;
    using Strings for *;
    ...
    struct DeploymentData {
        address incredibleRedisServiceManager;
        address incredibleRedisTaskManager;
    ...
    struct IncredibleRedisSetupConfig {
        uint256 numQuorums;
    ...
    function deployContracts(
        ...
        address strategy,
        IncredibleRedisSetupConfig memory idpConfig,
        address admin
        ...
        result.incredibleRedisServiceManager = UpgradeableProxyLib.setUpEmptyProxy(proxyAdmin);
        result.stakeRegistry = UpgradeableProxyLib.setUpEmptyProxy(proxyAdmin);
        result.incredibleRedisTaskManager = UpgradeableProxyLib.setUpEmptyProxy(proxyAdmin);
        ...
        uint256 numQuorums = idpConfig.numQuorums;
        ...
        uint256[] memory operator_params = idpConfig.operatorParams;
