...
// forge script script/IncredibleRedisDeployer.s.sol:IncredibleRedisDeployer --rpc-url $RPC_URL  --private-key $PRIVATE_KEY --broadcast -vvvv

contract IncredibleRedisDeployer is Script {
    ...
    ProxyAdmin public incredibleRedisProxyAdmin;
    PauserRegistry public incredibleRedisPauserReg;
    ...
    IncredibleRedisServiceManager public incredibleRedisServiceManager;
    IServiceManager public incredibleRedisServiceManagerImplementation;

    IncredibleRedisTaskManager public incredibleRedisTaskManager;
    IIncredibleRedisTaskManager public incredibleRedisTaskManagerImplementation;
    CoreDeploymentLib.DeploymentData internal configData;
    IStrategy incredibleRedisStrategy;
    address private deployer;
    MockERC20 public erc20Mock;
    IncredibleRedisDeploymentLib.DeploymentData incredibleRedisDeployment;
    ...
    function run() external {
        ...
        IncredibleRedisDeploymentLib.IncredibleRedisSetupConfig memory idpConfig =
        IncredibleRedisDeploymentLib.readIncredibleRedisConfigJson(
