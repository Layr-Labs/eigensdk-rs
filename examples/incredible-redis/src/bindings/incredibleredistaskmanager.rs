...
pub mod IIncredibleRedisTaskManager {
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolStruct for SetInput {
            ...
            #[inline]
            fn eip712_root_type() -> alloy_sol_types::private::Cow<'static, str> {
                alloy_sol_types::private::Cow::Borrowed("SetInput(string key,string value)")
            }
            #[inline]
            fn eip712_components(
            ) -> alloy_sol_types::private::Vec<alloy_sol_types::private::Cow<'static, str>>
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolStruct for Task {
            ...
            ) -> alloy_sol_types::private::Vec<alloy_sol_types::private::Cow<'static, str>>
            {
                ...
                components.push(<SetInput as alloy_sol_types::SolStruct>::eip712_root_type());
                components.extend(<SetInput as alloy_sol_types::SolStruct>::eip712_components());
                components
            }
            #[inline]
            fn eip712_encode_data(&self) -> alloy_sol_types::private::Vec<u8> {
        ...
        impl alloy_sol_types::EventTopic for Task {
            ...
            fn encode_topic_preimage(
                ...
                out.reserve(<Self as alloy_sol_types::EventTopic>::topic_preimage_length(rust));
                <SetInput as alloy_sol_types::EventTopic>::encode_topic_preimage(&rust.input, out);
                <alloy::sol_types::sol_data::Uint<
                    32,
                > as alloy_sol_types::EventTopic>::encode_topic_preimage(
                    &rust.taskCreatedBlock,
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IIncredibleRedisTaskManagerInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    ...
    impl<T, P: ::core::clone::Clone, N> IIncredibleRedisTaskManagerInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IIncredibleRedisTaskManagerInstance<T, P, N> {
...
pub mod IncredibleRedisTaskManager {
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolEvent for TaskResponded {
            ...
            const SIGNATURE_HASH: alloy_sol_types::private::B256 =
                alloy_sol_types::private::B256::new([
                    155u8, 150u8, 201u8, 129u8, 199u8, 199u8, 10u8, 159u8, 23u8, 2u8, 171u8, 176u8,
                    68u8, 120u8, 39u8, 70u8, 193u8, 29u8, 9u8, 15u8, 88u8, 234u8, 52u8, 177u8,
                    45u8, 175u8, 44u8, 197u8, 60u8, 248u8, 171u8, 95u8,
                ]);
            const ANONYMOUS: bool = false;
            #[allow(unused_variables)]
            #[inline]
    ...
    impl alloy_sol_types::SolInterface for IncredibleRedisTaskManagerCalls {
        ...
        fn selector(&self) -> [u8; 4] {
            match self {
                ...
                Self::redisState(_) => <redisStateCall as alloy_sol_types::SolCall>::SELECTOR,
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                IncredibleRedisTaskManagerCalls,
            >] = &[
                {
                    fn pause(
                        data: &[u8],
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<IncredibleRedisTaskManagerCalls>
                    {
                        ...
                        .map(IncredibleRedisTaskManagerCalls::raiseAndResolveChallenge)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<IncredibleRedisTaskManagerCalls>
                    {
                        ...
                        .map(IncredibleRedisTaskManagerCalls::setStaleStakesForbidden)
                    }
                ...
                },
                {
                    ...
                    {
                        <redisStateCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<IncredibleRedisTaskManagerCalls>
                    {
                        ...
                        .map(IncredibleRedisTaskManagerCalls::getCheckSignaturesIndices)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<IncredibleRedisTaskManagerCalls>
                    {
                        ...
                        .map(IncredibleRedisTaskManagerCalls::taskSuccesfullyChallenged)
                    }
        ...
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                ...
                Self::redisState(inner) => {
                    <redisStateCall as alloy_sol_types::SolCall>::abi_encode_raw(inner, out)
                }
                Self::registryCoordinator(inner) => {
    ...
    impl alloy_sol_types::SolInterface for IncredibleRedisTaskManagerErrors {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                IncredibleRedisTaskManagerErrors,
            >] = &[
                {
                    ...
                    ) -> alloy_sol_types::Result<IncredibleRedisTaskManagerErrors>
                    {
                        ...
                        .map(IncredibleRedisTaskManagerErrors::InputEmptyQuorumNumbers)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<IncredibleRedisTaskManagerErrors>
                    {
                        ...
                        .map(IncredibleRedisTaskManagerErrors::InputArrayLengthMismatch)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<IncredibleRedisTaskManagerErrors>
                    {
                        ...
                        .map(IncredibleRedisTaskManagerErrors::InvalidReferenceBlocknumber)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<IncredibleRedisTaskManagerErrors>
                    {
                        ...
                        .map(IncredibleRedisTaskManagerErrors::InputNonSignerLengthMismatch)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<IncredibleRedisTaskManagerErrors>
                    {
                        ...
                        .map(IncredibleRedisTaskManagerErrors::InvalidNewPausedStatus)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<IncredibleRedisTaskManagerErrors>
                    {
                        ...
                        .map(IncredibleRedisTaskManagerErrors::OnlyRegistryCoordinatorOwner)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<IncredibleRedisTaskManagerErrors>
                    {
                        ...
                        .map(IncredibleRedisTaskManagerErrors::BytesArrayLengthTooLong)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<IncredibleRedisTaskManagerErrors>
                    {
                        ...
                        .map(IncredibleRedisTaskManagerErrors::NonSignerPubkeysNotSorted)
                    }
    ...
    impl IncredibleRedisTaskManagerEvents {
        ...
        pub const SELECTORS: &'static [[u8; 32usize]] = &[
            ...
            [
                155u8, 150u8, 201u8, 129u8, 199u8, 199u8, 10u8, 159u8, 23u8, 2u8, 171u8, 176u8,
                68u8, 120u8, 39u8, 70u8, 193u8, 29u8, 9u8, 15u8, 88u8, 234u8, 52u8, 177u8, 45u8,
                175u8, 44u8, 197u8, 60u8, 248u8, 171u8, 95u8,
            ],
            [
    ...
    > {
        IncredibleRedisTaskManagerInstance::<T, P, N>::deploy(
            provider,
    ...
    >(
        ...
        IncredibleRedisTaskManagerInstance::<T, P, N>::deploy_builder(
            provider,
            _registryCoordinator,
            _pauserRegistry,
            _taskResponseWindowBlock,
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IncredibleRedisTaskManagerInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    ...
    impl<T, P: ::core::clone::Clone, N> IncredibleRedisTaskManagerInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IncredibleRedisTaskManagerInstance<T, P, N> {
