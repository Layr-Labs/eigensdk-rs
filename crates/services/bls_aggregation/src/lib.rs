...
//! ## Example Diagram
//!
//! The [following diagram](https://github.com/Layr-Labs/eigensdk-rs/blob/dev/crates/services/bls_aggregation/README.md#example-diagram) shows the sequence of events when a user creates the BLS Aggregator Service, starts the service, and then initializes a task. The service processes two signatures from the operators and then aggregates them into a single aggregated signature.
//!
//! ## Testing
//!
