...
use tracing::info;
use RegistryCoordinator::{G1Point, SignatureWithSaltAndExpiry};
    ...
    pub async fn register_operator_in_quorum_with_avs_registry_coordinator(
        ...
        match g1_hashes_msg_to_sign_return_result {
            Ok(g1_hashes_msg_to_sign_return) => {
                ...
                println!(
                    "g1 to alloy{:?}",
                    alloy_g1_point_to_g1_affine(g1_hashes_msg_to_sign.clone())
                );
                ...
                println!("g1_pub_key_bn254{:?}", g1_pub_key_bn254);
                let g2_pub_key_bn254 = convert_to_g2_point(bls_key_pair.public_key_g2().g2());
                println!("g2_pub_key_bn254{:?}", g2_pub_key_bn254.X[0]);
