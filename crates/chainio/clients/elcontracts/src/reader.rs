...
mod tests {
    use super::*;
    use crate::test_utils::{build_el_chain_reader, new_simple_claim, OPERATOR_ADDRESS};
    ...
    async fn test_get_distribution_roots_length() {
        ...
        _ = new_simple_claim(&http_endpoint).await;
    ...
    async fn test_get_current_claimable_distribution_root() {
        ...
        let (root, _) = new_simple_claim(&http_endpoint).await;
    ...
    async fn test_check_claim() {
        ...
        let (_, claim) = new_simple_claim(&http_endpoint).await;
