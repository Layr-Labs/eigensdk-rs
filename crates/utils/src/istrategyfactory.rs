...
```*/
    ...
    ///Container for all the [`IStrategyFactory`](self) function calls.
    pub enum IStrategyFactoryCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IStrategyFactoryCalls {
        const NAME: &'static str = "IStrategyFactoryCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IStrategyFactoryCalls>] = &[
                {
                    fn deployedStrategies(
                        ...
                        <deployedStrategiesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IStrategyFactoryCalls::deployedStrategies)
                    }
                    deployedStrategies
                },
                {
                    fn deployNewStrategy(
                        ...
                        <deployNewStrategyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IStrategyFactoryCalls::deployNewStrategy)
                    }
                    deployNewStrategy
                },
                {
                    fn whitelistStrategies(
                        ...
                        <whitelistStrategiesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IStrategyFactoryCalls::whitelistStrategies)
                    }
                    whitelistStrategies
                },
                {
                    fn strategyBeacon(
                        ...
                        <strategyBeaconCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IStrategyFactoryCalls::strategyBeacon)
                    }
                    strategyBeacon
                },
                {
                    fn removeStrategiesFromWhitelist(
                        ...
                        <removeStrategiesFromWhitelistCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IStrategyFactoryCalls::removeStrategiesFromWhitelist)
                    }
    ...
    ///Container for all the [`IStrategyFactory`](self) custom errors.
    pub enum IStrategyFactoryErrors {
        AlreadyBlacklisted(AlreadyBlacklisted),
        BlacklistedToken(BlacklistedToken),
        StrategyAlreadyExists(StrategyAlreadyExists),
    }
    #[automatically_derived]
    impl IStrategyFactoryErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IStrategyFactoryErrors {
        const NAME: &'static str = "IStrategyFactoryErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IStrategyFactoryErrors>] = &[
                {
                    fn BlacklistedToken(
                        data: &[u8],
                        validate: bool,
                        ...
                        <BlacklistedToken as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IStrategyFactoryErrors::BlacklistedToken)
                    }
                    BlacklistedToken
                },
                {
                    fn StrategyAlreadyExists(
                        ...
                        <StrategyAlreadyExists as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IStrategyFactoryErrors::StrategyAlreadyExists)
                    }
                ...
                },
                {
                    fn AlreadyBlacklisted(
                        ...
                        <AlreadyBlacklisted as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IStrategyFactoryErrors::AlreadyBlacklisted)
                    }
                    AlreadyBlacklisted
                },
            ];
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IStrategyFactoryEvents {
        const NAME: &'static str = "IStrategyFactoryEvents";
        const COUNT: usize = 3usize;
        fn decode_raw_log(
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IStrategyFactoryEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`IStrategyFactory`](self) contract instance.

See the [wrapper's documentation](`IStrategyFactoryInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IStrategyFactoryInstance<T, P, N> {
        IStrategyFactoryInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IStrategyFactoryInstance<T, P, N>>,
    > {
        IStrategyFactoryInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IStrategyFactoryInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IStrategyFactory`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IStrategyFactory`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IStrategyFactoryInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IStrategyFactoryInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IStrategyFactoryInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IStrategyFactoryInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IStrategyFactoryInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IStrategyFactoryInstance<T, P, N> {
            IStrategyFactoryInstance {
    ...
    > IStrategyFactoryInstance<T, P, N> {
        ...
        pub fn deployedStrategies(
            ...
            self.call_builder(&deployedStrategiesCall { token })
        }
