...
pub mod IntegrationDeployer {
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<_upgradeHoleskyContractsCall> for UnderlyingRustTuple<'_> {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for _upgradeHoleskyContractsCall {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self {}
                }
            }
        }
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<_upgradeHoleskyContractsReturn> for UnderlyingRustTuple<'_> {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for _upgradeHoleskyContractsReturn {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self {}
                }
            }
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<_upgradeMainnetContractsCall> for UnderlyingRustTuple<'_> {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for _upgradeMainnetContractsCall {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self {}
                }
            }
        }
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<_upgradeMainnetContractsReturn> for UnderlyingRustTuple<'_> {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for _upgradeMainnetContractsReturn {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self {}
                }
            }
    ...
    const _: () = {
        ...
        }
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<tokensNotTestedReturn> for UnderlyingRustTuple<'_> {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for tokensNotTestedReturn {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self { _0: tuple.0 }
                }
            }
    ...
    ///Container for all the [`IntegrationDeployer`](self) function calls.
    pub enum IntegrationDeployerCalls {
        EIGEN(EIGENCall),
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IntegrationDeployerCalls {
        const NAME: &'static str = "IntegrationDeployerCalls";
        ...
        fn selector(&self) -> [u8; 4] {
            match self {
                ...
                Self::_setUpLocal(_) => <_setUpLocalCall as alloy_sol_types::SolCall>::SELECTOR,
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<IntegrationDeployerCalls>] = &[
                {
                    fn strategyFactoryBeaconImplementation(
                        ...
                        <strategyFactoryBeaconImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                IntegrationDeployerCalls::strategyFactoryBeaconImplementation,
                            )
                    }
                ...
                },
                {
                    fn EIGENImpl(
                        ...
                        <EIGENImplCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IntegrationDeployerCalls::EIGENImpl)
                    }
                    EIGENImpl
                },
                {
                    fn setUp(
                        ...
                        <setUpCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IntegrationDeployerCalls::setUp)
                    }
                    setUp
                },
                {
                    fn _upgradeHoleskyContracts(
                        ...
                        .map(IntegrationDeployerCalls::_upgradeHoleskyContracts)
                    }
                ...
                },
                {
                    fn strategyFactoryImplementation(
                        ...
                        <strategyFactoryImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationDeployerCalls::strategyFactoryImplementation)
                    }
                ...
                },
                {
                    fn excludeSenders(
                        ...
                        .map(IntegrationDeployerCalls::excludeSenders)
                    }
                    excludeSenders
                },
                {
                    fn eigenStrategyImpl(
                        ...
                        .map(IntegrationDeployerCalls::eigenStrategyImpl)
                    }
                    eigenStrategyImpl
                },
                {
                    fn beaconChain(
                        ...
                        .map(IntegrationDeployerCalls::beaconChain)
                    }
                    beaconChain
                },
                {
                    fn bEIGENImpl(
                        ...
                        <bEIGENImplCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IntegrationDeployerCalls::bEIGENImpl)
                    }
                    bEIGENImpl
                },
                {
                    fn eigenPodBeacon(
                        ...
                        .map(IntegrationDeployerCalls::eigenPodBeacon)
                    }
                    eigenPodBeacon
                },
                {
                    fn targetInterfaces(
                        ...
                        .map(IntegrationDeployerCalls::targetInterfaces)
                    }
                    targetInterfaces
                },
                {
                    fn allocationManagerImplementation(
                        ...
                        <allocationManagerImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                IntegrationDeployerCalls::allocationManagerImplementation,
                            )
                    }
                ...
                },
                {
                    fn strategyManager(
                        ...
                        .map(IntegrationDeployerCalls::strategyManager)
                    }
                    strategyManager
                },
                {
                    fn timeMachine(
                        ...
                        .map(IntegrationDeployerCalls::timeMachine)
                    }
                    timeMachine
                },
                {
                    fn avsDirectoryImplementation(
                        ...
                        <avsDirectoryImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationDeployerCalls::avsDirectoryImplementation)
                    }
                ...
                },
                {
                    fn targetSenders(
                        ...
                        .map(IntegrationDeployerCalls::targetSenders)
                    }
                    targetSenders
                },
                {
                    fn singleValidatorPods(
                        ...
                        .map(IntegrationDeployerCalls::singleValidatorPods)
                    }
                    singleValidatorPods
                },
                {
                    fn bEIGEN(
                        ...
                        <bEIGENCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IntegrationDeployerCalls::bEIGEN)
                    }
                    bEIGEN
                },
                {
                    fn targetContracts(
                        ...
                        .map(IntegrationDeployerCalls::targetContracts)
                    }
                    targetContracts
                },
                {
                    fn eigenPodManager(
                        ...
                        .map(IntegrationDeployerCalls::eigenPodManager)
                    }
                    eigenPodManager
                },
                {
                    fn strategiesToDeploy(
                        ...
                        .map(IntegrationDeployerCalls::strategiesToDeploy)
                    }
                    strategiesToDeploy
                },
                {
                    fn inActivePods(
                        ...
                        .map(IntegrationDeployerCalls::inActivePods)
                    }
                    inActivePods
                },
                {
                    fn logAndOutputContractAddresses(
                        ...
                        <logAndOutputContractAddressesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationDeployerCalls::logAndOutputContractAddresses)
                    }
                ...
                },
                {
                    fn allEigenPods(
                        ...
                        .map(IntegrationDeployerCalls::allEigenPods)
                    }
                    allEigenPods
                },
                {
                    fn logInitialDeploymentParams(
                        ...
                        <logInitialDeploymentParamsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationDeployerCalls::logInitialDeploymentParams)
                    }
                ...
                },
                {
                    fn targetArtifactSelectors(
                        ...
                        .map(IntegrationDeployerCalls::targetArtifactSelectors)
                    }
                ...
                },
                {
                    fn avsDirectory(
                        ...
                        .map(IntegrationDeployerCalls::avsDirectory)
                    }
                    avsDirectory
                },
                {
                    fn eigenLayerPauserReg(
                        ...
                        .map(IntegrationDeployerCalls::eigenLayerPauserReg)
                    }
                    eigenLayerPauserReg
                },
                {
                    fn rewardsCoordinatorImplementation(
                        ...
                        <rewardsCoordinatorImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                IntegrationDeployerCalls::rewardsCoordinatorImplementation,
                            )
                    }
                ...
                },
                {
                    fn targetArtifacts(
                        ...
                        .map(IntegrationDeployerCalls::targetArtifacts)
                    }
                    targetArtifacts
                },
                {
                    fn rewardsCoordinator(
                        ...
                        .map(IntegrationDeployerCalls::rewardsCoordinator)
                    }
                    rewardsCoordinator
                },
                {
                    fn targetSelectors(
                        ...
                        .map(IntegrationDeployerCalls::targetSelectors)
                    }
                    targetSelectors
                },
                {
                    fn _upgradeMainnetContracts(
                        ...
                        .map(IntegrationDeployerCalls::_upgradeMainnetContracts)
                    }
                ...
                },
                {
                    fn baseStrategyImplementation(
                        ...
                        <baseStrategyImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationDeployerCalls::baseStrategyImplementation)
                    }
                ...
                },
                {
                    fn strategyFactory(
                        ...
                        .map(IntegrationDeployerCalls::strategyFactory)
                    }
                    strategyFactory
                },
                {
                    fn excludeSelectors(
                        ...
                        .map(IntegrationDeployerCalls::excludeSelectors)
                    }
                    excludeSelectors
                },
                {
                    fn excludeArtifacts(
                        ...
                        .map(IntegrationDeployerCalls::excludeArtifacts)
                    }
                    excludeArtifacts
                },
                {
                    fn _setUpLocal(
                        ...
                        .map(IntegrationDeployerCalls::_setUpLocal)
                    }
                    _setUpLocal
                },
                {
                    fn failed(
                        ...
                        <failedCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IntegrationDeployerCalls::failed)
                    }
                    failed
                },
                {
                    fn multiValidatorPods(
                        ...
                        .map(IntegrationDeployerCalls::multiValidatorPods)
                    }
                    multiValidatorPods
                },
                {
                    fn delegationManagerImplementation(
                        ...
                        <delegationManagerImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                IntegrationDeployerCalls::delegationManagerImplementation,
                            )
                    }
                ...
                },
                {
                    fn strategyManagerImplementation(
                        ...
                        <strategyManagerImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationDeployerCalls::strategyManagerImplementation)
                    }
                ...
                },
                {
                    fn allocationManager(
                        ...
                        .map(IntegrationDeployerCalls::allocationManager)
                    }
                    allocationManager
                },
                {
                    fn eigenLayerProxyAdmin(
                        ...
                        .map(IntegrationDeployerCalls::eigenLayerProxyAdmin)
                    }
                ...
                },
                {
                    fn eigenStrategy(
                        ...
                        .map(IntegrationDeployerCalls::eigenStrategy)
                    }
                    eigenStrategy
                },
                {
                    fn excludeContracts(
                        ...
                        .map(IntegrationDeployerCalls::excludeContracts)
                    }
                    excludeContracts
                },
                {
                    fn emptyContract(
                        ...
                        .map(IntegrationDeployerCalls::emptyContract)
                    }
                    emptyContract
                },
                {
                    fn deployedStrategyArray(
                        ...
                        .map(IntegrationDeployerCalls::deployedStrategyArray)
                    }
                ...
                },
                {
                    fn tokensNotTested(
                        ...
                        .map(IntegrationDeployerCalls::tokensNotTested)
                    }
                    tokensNotTested
                },
                {
                    fn delegationManager(
                        ...
                        .map(IntegrationDeployerCalls::delegationManager)
                    }
                    delegationManager
                },
                {
                    fn strategyBeacon(
                        ...
                        .map(IntegrationDeployerCalls::strategyBeacon)
                    }
                    strategyBeacon
                },
                {
                    fn tokenProxyAdmin(
                        ...
                        .map(IntegrationDeployerCalls::tokenProxyAdmin)
                    }
                    tokenProxyAdmin
                },
                {
                    fn eigenPodManagerImplementation(
                        ...
                        <eigenPodManagerImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationDeployerCalls::eigenPodManagerImplementation)
                    }
                ...
                },
                {
                    fn eigenPodImplementation(
                        ...
                        .map(IntegrationDeployerCalls::eigenPodImplementation)
                    }
                ...
                },
                {
                    fn IS_SCRIPT(
                        ...
                        <IS_SCRIPTCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IntegrationDeployerCalls::IS_SCRIPT)
                    }
                    IS_SCRIPT
                },
                {
                    fn IS_TEST(
                        ...
                        <IS_TESTCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IntegrationDeployerCalls::IS_TEST)
                    }
                    IS_TEST
                },
                {
                    fn EIGEN(
                        ...
                        <EIGENCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IntegrationDeployerCalls::EIGEN)
                    }
                    EIGEN
                },
            ];
    ...
    ///Container for all the [`IntegrationDeployer`](self) events.
    pub enum IntegrationDeployerEvents {
        log(log),
    ...
    #[automatically_derived]
    impl IntegrationDeployerEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IntegrationDeployerEvents {
        const NAME: &'static str = "IntegrationDeployerEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IntegrationDeployerEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`IntegrationDeployer`](self) contract instance.

    See the [wrapper's documentation](`IntegrationDeployerInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IntegrationDeployerInstance<T, P, N> {
        IntegrationDeployerInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IntegrationDeployerInstance<T, P, N>>>
    {
        IntegrationDeployerInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IntegrationDeployerInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IntegrationDeployer`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`IntegrationDeployer`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IntegrationDeployerInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IntegrationDeployerInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IntegrationDeployerInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        > IntegrationDeployerInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IntegrationDeployerInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> IntegrationDeployerInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IntegrationDeployerInstance<T, P, N> {
            IntegrationDeployerInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
        ...
        > IntegrationDeployerInstance<T, P, N>
    {
        ...
        pub fn _setUpLocal(&self) -> alloy_contract::SolCallBuilder<T, &P, _setUpLocalCall, N> {
