...
pub mod PrintUtils {
    ...
    ///Container for all the [`PrintUtils`](self) function calls.
    pub enum PrintUtilsCalls {
        IS_TEST(IS_TESTCall),
        NAME(NAMECall),
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for PrintUtilsCalls {
        const NAME: &'static str = "PrintUtilsCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<PrintUtilsCalls>] = &[
                {
                    fn excludeSenders(
                        data: &[u8],
                        validate: bool,
                    ) -> alloy_sol_types::Result<PrintUtilsCalls> {
                        <excludeSendersCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            data, validate,
                        )
                        .map(PrintUtilsCalls::excludeSenders)
                    }
                    excludeSenders
                },
                {
                    fn targetInterfaces(
                        ...
                        .map(PrintUtilsCalls::targetInterfaces)
                    }
                    targetInterfaces
                },
                {
                    fn targetSenders(
                        ...
                        .map(PrintUtilsCalls::targetSenders)
                    }
                    targetSenders
                },
                {
                    fn targetContracts(
                        ...
                        .map(PrintUtilsCalls::targetContracts)
                    }
                    targetContracts
                },
                {
                    fn targetArtifactSelectors(
                        ...
                        .map(PrintUtilsCalls::targetArtifactSelectors)
                    }
                ...
                },
                {
                    fn targetArtifacts(
                        ...
                        .map(PrintUtilsCalls::targetArtifacts)
                    }
                    targetArtifacts
                },
                {
                    fn targetSelectors(
                        ...
                        .map(PrintUtilsCalls::targetSelectors)
                    }
                    targetSelectors
                },
                {
                ...
                },
                {
                    fn excludeSelectors(
                        ...
                        .map(PrintUtilsCalls::excludeSelectors)
                    }
                    excludeSelectors
                },
                {
                    fn excludeArtifacts(
                        ...
                        .map(PrintUtilsCalls::excludeArtifacts)
                    }
                    excludeArtifacts
                },
                {
                ...
                },
                {
                    fn excludeContracts(
                        ...
                        .map(PrintUtilsCalls::excludeContracts)
                    }
                    excludeContracts
                },
                {
    ...
    ///Container for all the [`PrintUtils`](self) events.
    pub enum PrintUtilsEvents {
        log(log),
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for PrintUtilsEvents {
        const NAME: &'static str = "PrintUtilsEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for PrintUtilsEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`PrintUtils`](self) contract instance.

    See the [wrapper's documentation](`PrintUtilsInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> PrintUtilsInstance<T, P, N> {
        PrintUtilsInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<PrintUtilsInstance<T, P, N>>>
    {
        PrintUtilsInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        PrintUtilsInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`PrintUtils`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`PrintUtils`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct PrintUtilsInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for PrintUtilsInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("PrintUtilsInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        > PrintUtilsInstance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<PrintUtilsInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> PrintUtilsInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> PrintUtilsInstance<T, P, N> {
            PrintUtilsInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
