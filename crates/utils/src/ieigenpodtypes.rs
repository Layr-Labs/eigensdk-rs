...
pub mod IEigenPodTypes {
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IEigenPodTypesInstance<T, P, N>>>
    {
        IEigenPodTypesInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IEigenPodTypesInstance::<T, P, N>::deploy_builder(provider)
    }
        ...
        > IEigenPodTypesInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IEigenPodTypesInstance<T, P, N>> {
