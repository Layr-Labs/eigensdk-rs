...
pub mod IEigenPodErrors {
                ...
                },
                {
                    fn WithdrawCredentialsNotForEigenPod(
                        ...
                        <WithdrawCredentialsNotForEigenPod as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                IEigenPodErrorsErrors::WithdrawCredentialsNotForEigenPod,
                            )
                    }
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IEigenPodErrorsInstance<T, P, N>>>
    {
    ...
    impl<T, P, N> ::core::fmt::Debug for IEigenPodErrorsInstance<T, P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IEigenPodErrorsInstance")
                .field(&self.address)
                .finish()
        }
    }
