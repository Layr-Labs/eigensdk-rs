...
pub mod IBLSApkRegistryEvents {
    ...
    ///Container for all the [`IBLSApkRegistryEvents`](self) events.
    ...
    #[automatically_derived]
    impl IBLSApkRegistryEventsEvents {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IBLSApkRegistryEventsEvents {
        const NAME: &'static str = "IBLSApkRegistryEventsEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IBLSApkRegistryEventsEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`IBLSApkRegistryEvents`](self) contract instance.

    See the [wrapper's documentation](`IBLSApkRegistryEventsInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IBLSApkRegistryEventsInstance<T, P, N> {
        IBLSApkRegistryEventsInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        ...
        Output = alloy_contract::Result<IBLSApkRegistryEventsInstance<T, P, N>>,
    > {
        IBLSApkRegistryEventsInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IBLSApkRegistryEventsInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IBLSApkRegistryEvents`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`IBLSApkRegistryEvents`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IBLSApkRegistryEventsInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IBLSApkRegistryEventsInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IBLSApkRegistryEventsInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        > IBLSApkRegistryEventsInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IBLSApkRegistryEventsInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> IBLSApkRegistryEventsInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IBLSApkRegistryEventsInstance<T, P, N> {
            IBLSApkRegistryEventsInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
