...
pub mod G2Operations {
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<G2OperationsInstance<T, P, N>>>
    {
    ...
    impl<T, P, N> ::core::fmt::Debug for G2OperationsInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("G2OperationsInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        > G2OperationsInstance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<G2OperationsInstance<T, P, N>> {
