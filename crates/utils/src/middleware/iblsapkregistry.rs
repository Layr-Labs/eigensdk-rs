...
interface IBLSApkRegistry {
    ...
    function registerBLSPublicKey(address operator, PubkeyRegistrationParams memory params, BN254.G1Point memory pubkeyRegistrationMessageHash) external returns (bytes32 operatorId);
...
```*/
    ...
    pub struct getApkUpdateAtIndexReturn {
        pub _0: <ApkUpdate as alloy::sol_types::SolType>::RustType,
    }
    #[allow(
        non_camel_case_types,
        non_snake_case,
    ...
    const _: () = {
        ...
        {
            #[doc(hidden)]
            type UnderlyingSolTuple<'a> = (ApkUpdate,);
            #[doc(hidden)]
            type UnderlyingRustTuple<'a> = (
                <ApkUpdate as alloy::sol_types::SolType>::RustType,
            );
            #[cfg(test)]
            #[allow(dead_code, unreachable_patterns)]
            fn _type_assertion(
...
```*/
    ...
    pub struct registerBLSPublicKeyCall {
        pub operator: alloy::sol_types::private::Address,
        pub params: <PubkeyRegistrationParams as alloy::sol_types::SolType>::RustType,
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            type UnderlyingRustTuple<'a> = (
                alloy::sol_types::private::Address,
                <PubkeyRegistrationParams as alloy::sol_types::SolType>::RustType,
                <BN254::G1Point as alloy::sol_types::SolType>::RustType,
            );
            #[cfg(test)]
            #[allow(dead_code, unreachable_patterns)]
        ...
        impl alloy_sol_types::SolCall for registerBLSPublicKeyCall {
            ...
            fn tokenize(&self) -> Self::Token<'_> {
                (
                    ...
                    <PubkeyRegistrationParams as alloy_sol_types::SolType>::tokenize(
                        &self.params,
                    ),
                    <BN254::G1Point as alloy_sol_types::SolType>::tokenize(
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    > IBLSApkRegistryInstance<T, P, N> {
        ...
        pub fn registerBLSPublicKey(
            &self,
            operator: alloy::sol_types::private::Address,
            params: <PubkeyRegistrationParams as alloy::sol_types::SolType>::RustType,
