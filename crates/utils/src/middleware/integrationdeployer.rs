...
```*/
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<churnApproverPrivateKeyCall>
            ...
            for churnApproverPrivateKeyCall {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self {}
                }
            }
        }
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<churnApproverPrivateKeyReturn>
            for UnderlyingRustTuple<'_> {
            ...
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>>
            for churnApproverPrivateKeyReturn {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self { _0: tuple.0 }
                }
            }
            ...
            ) -> alloy_sol_types::Result<IntegrationDeployerCalls>] = &[
                {
                    fn churnApprover(
                        ...
                        <churnApproverCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationDeployerCalls::churnApprover)
                    }
                    churnApprover
                },
                {
                ...
                },
                {
                    fn churnApproverPrivateKey(
                        ...
                        <churnApproverPrivateKeyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationDeployerCalls::churnApproverPrivateKey)
                    }
                ...
                },
                {
                    fn registryCoordinator(
                        ...
                        <registryCoordinatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationDeployerCalls::registryCoordinator)
                    }
                    registryCoordinator
                },
                {
                ...
                },
                {
                    fn registryCoordinatorOwner(
                        ...
                        <registryCoordinatorOwnerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationDeployerCalls::registryCoordinatorOwner)
                    }
