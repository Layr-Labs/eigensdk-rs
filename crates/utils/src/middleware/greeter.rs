...
pub mod Greeter {
    ...
    impl GreeterCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] =
            &[[239u8, 105u8, 12u8, 192u8], [246u8, 45u8, 24u8, 136u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for GreeterCalls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<GreeterCalls>] = &[
                {
                    fn greeting(
                        data: &[u8],
                        validate: bool,
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<GreeterInstance<T, P, N>>>
    {
        ...
        > GreeterInstance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<GreeterInstance<T, P, N>> {
