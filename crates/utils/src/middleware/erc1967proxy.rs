...
pub mod ERC1967Proxy {
    ...
    ///
    /// ```text
<<<<<<< HEAD:crates/utils/src/erc1967proxy.rs
...
>>>>>>> dev:crates/utils/src/middleware/erc1967proxy.rs
    /// ```
    #[rustfmt::skip]
    #[allow(clippy::all)]
