...
pub mod ProxyAdmin {
    ...
    ///
    /// ```text
<<<<<<< HEAD:crates/utils/src/proxyadmin.rs
...
>>>>>>> dev:crates/utils/src/middleware/proxyadmin.rs
    /// ```
    #[rustfmt::skip]
    #[allow(clippy::all)]
