            ...
            static DECODE_SHIMS: &[fn(
                ...
                },
                {
                    fn slashOperator(
                        ...
                        .map(ECDSAServiceManagerBaseCalls::slashOperator)
                    }
                    slashOperator
                },
                {
                ...
                },
                {
                    fn addStrategyToOperatorSet(
                        ...
                        .map(ECDSAServiceManagerBaseCalls::addStrategyToOperatorSet)
                    }
                ...
                },
                {
                    fn createOperatorSets(
                        ...
                        .map(ECDSAServiceManagerBaseCalls::createOperatorSets)
                    }
                    createOperatorSets
                },
                {
                ...
                },
                {
                    fn removeStrategiesFromOperatorSet(
                        ...
                        <removeStrategiesFromOperatorSetCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                ECDSAServiceManagerBaseCalls::removeStrategiesFromOperatorSet,
                            )
                    }
