...
pub mod IntegrationBase {
    ...
    ///Container for all the [`IntegrationBase`](self) function calls.
    pub enum IntegrationBaseCalls {
        EIGEN(EIGENCall),
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IntegrationBaseCalls {
        const NAME: &'static str = "IntegrationBaseCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<IntegrationBaseCalls>] = &[
                {
                    fn strategyFactoryBeaconImplementation(
                        ...
                        <strategyFactoryBeaconImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                IntegrationBaseCalls::strategyFactoryBeaconImplementation,
                            )
                    }
                ...
                },
                {
                    fn EIGENImpl(
                        ...
                        <EIGENImplCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IntegrationBaseCalls::EIGENImpl)
                    }
                    EIGENImpl
                },
                {
                    fn setUp(
                        ...
                        <setUpCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IntegrationBaseCalls::setUp)
                    }
                    setUp
                },
                {
                    fn _upgradeHoleskyContracts(
                        ...
                        .map(IntegrationBaseCalls::_upgradeHoleskyContracts)
                    }
                ...
                },
                {
                    fn strategyFactoryImplementation(
                        ...
                        <strategyFactoryImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationBaseCalls::strategyFactoryImplementation)
                    }
                ...
                },
                {
                    fn excludeSenders(
                        ...
                        .map(IntegrationBaseCalls::excludeSenders)
                    }
                    excludeSenders
                },
                {
                    fn eigenStrategyImpl(
                        ...
                        .map(IntegrationBaseCalls::eigenStrategyImpl)
                    }
                    eigenStrategyImpl
                },
                {
                    fn beaconChain(
                        ...
                        .map(IntegrationBaseCalls::beaconChain)
                    }
                    beaconChain
                },
                {
                    fn bEIGENImpl(
                        ...
                        <bEIGENImplCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IntegrationBaseCalls::bEIGENImpl)
                    }
                    bEIGENImpl
                },
                {
                    fn eigenPodBeacon(
                        ...
                        .map(IntegrationBaseCalls::eigenPodBeacon)
                    }
                    eigenPodBeacon
                },
                {
                    fn targetInterfaces(
                        ...
                        .map(IntegrationBaseCalls::targetInterfaces)
                    }
                    targetInterfaces
                },
                {
                    fn allocationManagerImplementation(
                        ...
                        <allocationManagerImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationBaseCalls::allocationManagerImplementation)
                    }
                ...
                },
                {
                    fn strategyManager(
                        ...
                        .map(IntegrationBaseCalls::strategyManager)
                    }
                    strategyManager
                },
                {
                    fn timeMachine(
                        ...
                        .map(IntegrationBaseCalls::timeMachine)
                    }
                    timeMachine
                },
                {
                    fn avsDirectoryImplementation(
                        ...
                        <avsDirectoryImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationBaseCalls::avsDirectoryImplementation)
                    }
                ...
                },
                {
                    fn targetSenders(
                        ...
                        .map(IntegrationBaseCalls::targetSenders)
                    }
                    targetSenders
                },
                {
                    fn singleValidatorPods(
                        ...
                        .map(IntegrationBaseCalls::singleValidatorPods)
                    }
                    singleValidatorPods
                },
                {
                    fn bEIGEN(
                        ...
                        <bEIGENCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IntegrationBaseCalls::bEIGEN)
                    }
                    bEIGEN
                },
                {
                    fn targetContracts(
                        ...
                        .map(IntegrationBaseCalls::targetContracts)
                    }
                    targetContracts
                },
                {
                    fn eigenPodManager(
                        ...
                        .map(IntegrationBaseCalls::eigenPodManager)
                    }
                    eigenPodManager
                },
                {
                    fn strategiesToDeploy(
                        ...
                        .map(IntegrationBaseCalls::strategiesToDeploy)
                    }
                    strategiesToDeploy
                },
                {
                    fn inActivePods(
                        ...
                        .map(IntegrationBaseCalls::inActivePods)
                    }
                    inActivePods
                },
                {
                    fn logAndOutputContractAddresses(
                        ...
                        <logAndOutputContractAddressesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationBaseCalls::logAndOutputContractAddresses)
                    }
                ...
                },
                {
                    fn allEigenPods(
                        ...
                        .map(IntegrationBaseCalls::allEigenPods)
                    }
                    allEigenPods
                },
                {
                    fn logInitialDeploymentParams(
                        ...
                        <logInitialDeploymentParamsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationBaseCalls::logInitialDeploymentParams)
                    }
                ...
                },
                {
                    fn targetArtifactSelectors(
                        ...
                        .map(IntegrationBaseCalls::targetArtifactSelectors)
                    }
                ...
                },
                {
                    fn avsDirectory(
                        ...
                        .map(IntegrationBaseCalls::avsDirectory)
                    }
                    avsDirectory
                },
                {
                    fn eigenLayerPauserReg(
                        ...
                        .map(IntegrationBaseCalls::eigenLayerPauserReg)
                    }
                    eigenLayerPauserReg
                },
                {
                    fn rewardsCoordinatorImplementation(
                        ...
                        <rewardsCoordinatorImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationBaseCalls::rewardsCoordinatorImplementation)
                    }
                ...
                },
                {
                    fn targetArtifacts(
                        ...
                        .map(IntegrationBaseCalls::targetArtifacts)
                    }
                    targetArtifacts
                },
                {
                    fn rewardsCoordinator(
                        ...
                        .map(IntegrationBaseCalls::rewardsCoordinator)
                    }
                    rewardsCoordinator
                },
                {
                    fn targetSelectors(
                        ...
                        .map(IntegrationBaseCalls::targetSelectors)
                    }
                    targetSelectors
                },
                {
                    fn _upgradeMainnetContracts(
                        ...
                        .map(IntegrationBaseCalls::_upgradeMainnetContracts)
                    }
                ...
                },
                {
                    fn baseStrategyImplementation(
                        ...
                        <baseStrategyImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationBaseCalls::baseStrategyImplementation)
                    }
                ...
                },
                {
                    fn strategyFactory(
                        ...
                        .map(IntegrationBaseCalls::strategyFactory)
                    }
                    strategyFactory
                },
                {
                    fn excludeSelectors(
                        ...
                        .map(IntegrationBaseCalls::excludeSelectors)
                    }
                    excludeSelectors
                },
                {
                    fn excludeArtifacts(
                        ...
                        .map(IntegrationBaseCalls::excludeArtifacts)
                    }
                    excludeArtifacts
                },
                {
                    fn _setUpLocal(
                        ...
                        .map(IntegrationBaseCalls::_setUpLocal)
                    }
                    _setUpLocal
                },
                {
                    fn failed(
                        ...
                        <failedCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IntegrationBaseCalls::failed)
                    }
                    failed
                },
                {
                    fn multiValidatorPods(
                        ...
                        .map(IntegrationBaseCalls::multiValidatorPods)
                    }
                    multiValidatorPods
                },
                {
                    fn delegationManagerImplementation(
                        ...
                        <delegationManagerImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationBaseCalls::delegationManagerImplementation)
                    }
                ...
                },
                {
                    fn strategyManagerImplementation(
                        ...
                        <strategyManagerImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationBaseCalls::strategyManagerImplementation)
                    }
                ...
                },
                {
                    fn allocationManager(
                        ...
                        .map(IntegrationBaseCalls::allocationManager)
                    }
                    allocationManager
                },
                {
                    fn eigenLayerProxyAdmin(
                        ...
                        .map(IntegrationBaseCalls::eigenLayerProxyAdmin)
                    }
                ...
                },
                {
                    fn eigenStrategy(
                        ...
                        .map(IntegrationBaseCalls::eigenStrategy)
                    }
                    eigenStrategy
                },
                {
                    fn excludeContracts(
                        ...
                        .map(IntegrationBaseCalls::excludeContracts)
                    }
                    excludeContracts
                },
                {
                    fn emptyContract(
                        ...
                        .map(IntegrationBaseCalls::emptyContract)
                    }
                    emptyContract
                },
                {
                    fn deployedStrategyArray(
                        ...
                        .map(IntegrationBaseCalls::deployedStrategyArray)
                    }
                ...
                },
                {
                    fn tokensNotTested(
                        ...
                        .map(IntegrationBaseCalls::tokensNotTested)
                    }
                    tokensNotTested
                },
                {
                    fn delegationManager(
                        ...
                        .map(IntegrationBaseCalls::delegationManager)
                    }
                    delegationManager
                },
                {
                    fn strategyBeacon(
                        ...
                        .map(IntegrationBaseCalls::strategyBeacon)
                    }
                    strategyBeacon
                },
                {
                    fn tokenProxyAdmin(
                        ...
                        .map(IntegrationBaseCalls::tokenProxyAdmin)
                    }
                    tokenProxyAdmin
                },
                {
                    fn eigenPodManagerImplementation(
                        ...
                        <eigenPodManagerImplementationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IntegrationBaseCalls::eigenPodManagerImplementation)
                    }
                ...
                },
                {
                    fn eigenPodImplementation(
                        ...
                        .map(IntegrationBaseCalls::eigenPodImplementation)
                    }
                ...
                },
                {
                    fn IS_SCRIPT(
                        ...
                        <IS_SCRIPTCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IntegrationBaseCalls::IS_SCRIPT)
                    }
                    IS_SCRIPT
                },
                {
                    fn IS_TEST(
                        ...
                        <IS_TESTCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IntegrationBaseCalls::IS_TEST)
                    }
                    IS_TEST
                },
                {
                    fn EIGEN(
                        ...
                        <EIGENCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IntegrationBaseCalls::EIGEN)
                    }
                    EIGEN
                },
            ];
    ...
    ///Container for all the [`IntegrationBase`](self) events.
    pub enum IntegrationBaseEvents {
        log(log),
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IntegrationBaseEvents {
        const NAME: &'static str = "IntegrationBaseEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IntegrationBaseEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`IntegrationBase`](self) contract instance.

    See the [wrapper's documentation](`IntegrationBaseInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IntegrationBaseInstance<T, P, N> {
        IntegrationBaseInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IntegrationBaseInstance<T, P, N>>>
    {
        IntegrationBaseInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IntegrationBaseInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IntegrationBase`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`IntegrationBase`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IntegrationBaseInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IntegrationBaseInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IntegrationBaseInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        > IntegrationBaseInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IntegrationBaseInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> IntegrationBaseInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IntegrationBaseInstance<T, P, N> {
            IntegrationBaseInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
