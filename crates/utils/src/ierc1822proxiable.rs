...
pub mod IERC1822Proxiable {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                fn proxiableUUID(
                    ...
                    <proxiableUUIDCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IERC1822ProxiableInstance<T, P, N>>>
    {
