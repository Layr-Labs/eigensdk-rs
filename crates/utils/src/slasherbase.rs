...
```*/
    ...
    ///Container for all the [`SlasherBase`](self) function calls.
    pub enum SlasherBaseCalls {
        nextRequestId(nextRequestIdCall),
        serviceManager(serviceManagerCall),
        slasher(slasherCall),
    }
    #[automatically_derived]
    impl SlasherBaseCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for SlasherBaseCalls {
        const NAME: &'static str = "SlasherBaseCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<SlasherBaseCalls>] = &[
                {
                    fn serviceManager(
                        data: &[u8],
                        validate: bool,
                        ...
                        <serviceManagerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlasherBaseCalls::serviceManager)
                    }
                    serviceManager
                },
                {
                    fn nextRequestId(
                        ...
                        <nextRequestIdCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlasherBaseCalls::nextRequestId)
                    }
                    nextRequestId
                },
                {
    ...
    ///Container for all the [`SlasherBase`](self) events.
    pub enum SlasherBaseEvents {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for SlasherBaseEvents {
        const NAME: &'static str = "SlasherBaseEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for SlasherBaseEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`SlasherBase`](self) contract instance.

See the [wrapper's documentation](`SlasherBaseInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> SlasherBaseInstance<T, P, N> {
        SlasherBaseInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<SlasherBaseInstance<T, P, N>>,
    > {
        SlasherBaseInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        SlasherBaseInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`SlasherBase`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`SlasherBase`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct SlasherBaseInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for SlasherBaseInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("SlasherBaseInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<SlasherBaseInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> SlasherBaseInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> SlasherBaseInstance<T, P, N> {
            SlasherBaseInstance {
