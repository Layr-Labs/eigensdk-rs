...
pub mod IAVSDirectoryTypes {
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IAVSDirectoryTypesInstance<T, P, N>>>
    {
        IAVSDirectoryTypesInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IAVSDirectoryTypesInstance::<T, P, N>::deploy_builder(provider)
    }
        ...
        > IAVSDirectoryTypesInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IAVSDirectoryTypesInstance<T, P, N>> {
