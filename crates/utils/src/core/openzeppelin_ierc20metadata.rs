...
```solidity
interface OpenZeppelin_IERC20Metadata {
...
pub mod OpenZeppelin_IERC20Metadata {
    ...
    ///Container for all the [`OpenZeppelin_IERC20Metadata`](self) function calls.
    pub enum OpenZeppelin_IERC20MetadataCalls {
    ...
    #[automatically_derived]
    impl OpenZeppelin_IERC20MetadataCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for OpenZeppelin_IERC20MetadataCalls {
        const NAME: &'static str = "OpenZeppelin_IERC20MetadataCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                OpenZeppelin_IERC20MetadataCalls,
            >] = &[
                {
                    fn name(
                        data: &[u8],
                        validate: bool,
                    ) -> alloy_sol_types::Result<OpenZeppelin_IERC20MetadataCalls>
                    {
                        <nameCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(OpenZeppelin_IERC20MetadataCalls::name)
                    }
                    name
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_IERC20MetadataCalls>
                    {
                        <approveCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(OpenZeppelin_IERC20MetadataCalls::approve)
                    }
                    approve
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_IERC20MetadataCalls>
                    {
                        ...
                        .map(OpenZeppelin_IERC20MetadataCalls::totalSupply)
                    }
                    totalSupply
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_IERC20MetadataCalls>
                    {
                        ...
                        .map(OpenZeppelin_IERC20MetadataCalls::transferFrom)
                    }
                    transferFrom
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_IERC20MetadataCalls>
                    {
                        <decimalsCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(OpenZeppelin_IERC20MetadataCalls::decimals)
                    }
                    decimals
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_IERC20MetadataCalls>
                    {
                        <balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(OpenZeppelin_IERC20MetadataCalls::balanceOf)
                    }
                    balanceOf
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_IERC20MetadataCalls>
                    {
                        <symbolCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(OpenZeppelin_IERC20MetadataCalls::symbol)
                    }
                    symbol
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_IERC20MetadataCalls>
                    {
                        <transferCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(OpenZeppelin_IERC20MetadataCalls::transfer)
                    }
                    transfer
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_IERC20MetadataCalls>
                    {
                        <allowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(OpenZeppelin_IERC20MetadataCalls::allowance)
                    }
                    allowance
                },
            ];
    ...
    ///Container for all the [`OpenZeppelin_IERC20Metadata`](self) events.
    pub enum OpenZeppelin_IERC20MetadataEvents {
        Approval(Approval),
        Transfer(Transfer),
    }
    #[automatically_derived]
    impl OpenZeppelin_IERC20MetadataEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for OpenZeppelin_IERC20MetadataEvents {
        const NAME: &'static str = "OpenZeppelin_IERC20MetadataEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for OpenZeppelin_IERC20MetadataEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`OpenZeppelin_IERC20Metadata`](self) contract instance.

    See the [wrapper's documentation](`OpenZeppelin_IERC20MetadataInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> OpenZeppelin_IERC20MetadataInstance<T, P, N> {
        OpenZeppelin_IERC20MetadataInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        ...
        Output = alloy_contract::Result<OpenZeppelin_IERC20MetadataInstance<T, P, N>>,
    > {
        OpenZeppelin_IERC20MetadataInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        OpenZeppelin_IERC20MetadataInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`OpenZeppelin_IERC20Metadata`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`OpenZeppelin_IERC20Metadata`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    #[derive(Clone)]
    pub struct OpenZeppelin_IERC20MetadataInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for OpenZeppelin_IERC20MetadataInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("OpenZeppelin_IERC20MetadataInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        > OpenZeppelin_IERC20MetadataInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<OpenZeppelin_IERC20MetadataInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> OpenZeppelin_IERC20MetadataInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> OpenZeppelin_IERC20MetadataInstance<T, P, N> {
            OpenZeppelin_IERC20MetadataInstance {
