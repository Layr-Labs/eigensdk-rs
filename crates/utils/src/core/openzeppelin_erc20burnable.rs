...
```solidity
interface OpenZeppelin_ERC20Burnable {
...
pub mod OpenZeppelin_ERC20Burnable {
    ...
    ///Container for all the [`OpenZeppelin_ERC20Burnable`](self) function calls.
    pub enum OpenZeppelin_ERC20BurnableCalls {
    ...
    #[automatically_derived]
    impl OpenZeppelin_ERC20BurnableCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for OpenZeppelin_ERC20BurnableCalls {
        const NAME: &'static str = "OpenZeppelin_ERC20BurnableCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                OpenZeppelin_ERC20BurnableCalls,
            >] = &[
                {
                    fn name(
                        data: &[u8],
                        validate: bool,
                    ) -> alloy_sol_types::Result<OpenZeppelin_ERC20BurnableCalls>
                    {
                        <nameCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(OpenZeppelin_ERC20BurnableCalls::name)
                    }
                    name
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_ERC20BurnableCalls>
                    {
                        <approveCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(OpenZeppelin_ERC20BurnableCalls::approve)
                    }
                    approve
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_ERC20BurnableCalls>
                    {
                        ...
                        .map(OpenZeppelin_ERC20BurnableCalls::totalSupply)
                    }
                    totalSupply
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_ERC20BurnableCalls>
                    {
                        ...
                        .map(OpenZeppelin_ERC20BurnableCalls::transferFrom)
                    }
                    transferFrom
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_ERC20BurnableCalls>
                    {
                        <decimalsCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(OpenZeppelin_ERC20BurnableCalls::decimals)
                    }
                    decimals
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_ERC20BurnableCalls>
                    {
                        ...
                        .map(OpenZeppelin_ERC20BurnableCalls::increaseAllowance)
                    }
                    increaseAllowance
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_ERC20BurnableCalls>
                    {
                        <burnCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(OpenZeppelin_ERC20BurnableCalls::burn)
                    }
                    burn
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_ERC20BurnableCalls>
                    {
                        <balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(OpenZeppelin_ERC20BurnableCalls::balanceOf)
                    }
                    balanceOf
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_ERC20BurnableCalls>
                    {
                        <burnFromCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(OpenZeppelin_ERC20BurnableCalls::burnFrom)
                    }
                    burnFrom
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_ERC20BurnableCalls>
                    {
                        <symbolCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(OpenZeppelin_ERC20BurnableCalls::symbol)
                    }
                    symbol
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_ERC20BurnableCalls>
                    {
                        ...
                        .map(OpenZeppelin_ERC20BurnableCalls::decreaseAllowance)
                    }
                    decreaseAllowance
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_ERC20BurnableCalls>
                    {
                        <transferCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(OpenZeppelin_ERC20BurnableCalls::transfer)
                    }
                    transfer
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<OpenZeppelin_ERC20BurnableCalls>
                    {
                        <allowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(OpenZeppelin_ERC20BurnableCalls::allowance)
                    }
                    allowance
                },
            ];
    ...
    ///Container for all the [`OpenZeppelin_ERC20Burnable`](self) events.
    pub enum OpenZeppelin_ERC20BurnableEvents {
        Approval(Approval),
        Transfer(Transfer),
    }
    #[automatically_derived]
    impl OpenZeppelin_ERC20BurnableEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for OpenZeppelin_ERC20BurnableEvents {
        const NAME: &'static str = "OpenZeppelin_ERC20BurnableEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for OpenZeppelin_ERC20BurnableEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`OpenZeppelin_ERC20Burnable`](self) contract instance.

    See the [wrapper's documentation](`OpenZeppelin_ERC20BurnableInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> OpenZeppelin_ERC20BurnableInstance<T, P, N> {
        OpenZeppelin_ERC20BurnableInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        ...
        Output = alloy_contract::Result<OpenZeppelin_ERC20BurnableInstance<T, P, N>>,
    > {
        OpenZeppelin_ERC20BurnableInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        OpenZeppelin_ERC20BurnableInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`OpenZeppelin_ERC20Burnable`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`OpenZeppelin_ERC20Burnable`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    #[derive(Clone)]
    pub struct OpenZeppelin_ERC20BurnableInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for OpenZeppelin_ERC20BurnableInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("OpenZeppelin_ERC20BurnableInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        > OpenZeppelin_ERC20BurnableInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<OpenZeppelin_ERC20BurnableInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> OpenZeppelin_ERC20BurnableInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> OpenZeppelin_ERC20BurnableInstance<T, P, N> {
            OpenZeppelin_ERC20BurnableInstance {
