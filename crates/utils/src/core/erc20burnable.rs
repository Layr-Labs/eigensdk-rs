...
pub mod ERC20Burnable {
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<ERC20BurnableInstance<T, P, N>>>
    {
    ...
    impl<T, P, N> ::core::fmt::Debug for ERC20BurnableInstance<T, P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ERC20BurnableInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        > ERC20BurnableInstance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<ERC20BurnableInstance<T, P, N>> {
