...
pub mod IERC20PermitUpgradeable {
    ...
    ///Container for all the [`IERC20PermitUpgradeable`](self) function calls.
    ...
    #[automatically_derived]
    impl IERC20PermitUpgradeableCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IERC20PermitUpgradeableCalls {
        const NAME: &'static str = "IERC20PermitUpgradeableCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<IERC20PermitUpgradeableCalls>] = &[
                {
                    fn DOMAIN_SEPARATOR(
                        data: &[u8],
                        validate: bool,
                        ...
                        .map(IERC20PermitUpgradeableCalls::DOMAIN_SEPARATOR)
                    }
                    DOMAIN_SEPARATOR
                },
                {
                    fn nonces(
                        ...
                        <noncesCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IERC20PermitUpgradeableCalls::nonces)
                    }
                    nonces
                },
                {
                    fn permit(
                        ...
                        <permitCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IERC20PermitUpgradeableCalls::permit)
                    }
                    permit
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IERC20PermitUpgradeable`](self) contract instance.

    See the [wrapper's documentation](`IERC20PermitUpgradeableInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IERC20PermitUpgradeableInstance<T, P, N> {
        IERC20PermitUpgradeableInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        ...
        Output = alloy_contract::Result<IERC20PermitUpgradeableInstance<T, P, N>>,
    > {
        IERC20PermitUpgradeableInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IERC20PermitUpgradeableInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IERC20PermitUpgradeable`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`IERC20PermitUpgradeable`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    #[derive(Clone)]
    pub struct IERC20PermitUpgradeableInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IERC20PermitUpgradeableInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IERC20PermitUpgradeableInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        > IERC20PermitUpgradeableInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IERC20PermitUpgradeableInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> IERC20PermitUpgradeableInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IERC20PermitUpgradeableInstance<T, P, N> {
