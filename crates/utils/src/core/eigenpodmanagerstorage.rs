...
pub mod EigenPodManagerStorage {
            ...
            static DECODE_SHIMS: &[fn(
                ...
                },
                {
                    fn podOwnerShares(
                        ...
                        .map(EigenPodManagerStorageCalls::podOwnerShares)
                    }
                    podOwnerShares
                },
                {
                ...
                },
                {
                    fn slasher(
                        ...
                        <slasherCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(EigenPodManagerStorageCalls::slasher)
                    }
                    slasher
                },
                {
                    fn removeShares(
                        ...
                        .map(EigenPodManagerStorageCalls::removeShares)
                    }
                    removeShares
                },
                {
        ...
        > EigenPodManagerStorageInstance<T, P, N>
    {
        ...
        pub fn podOwnerShares(
            ...
            self.call_builder(&podOwnerSharesCall { _0 })
        }
