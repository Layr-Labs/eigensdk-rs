...
interface AllocationManagerStorage {
    struct OperatorSet {
        address avs;
        uint32 id;
    }
...
pub mod AllocationManagerStorage {
    ...
    ///Container for all the [`AllocationManagerStorage`](self) function calls.
    pub enum AllocationManagerStorageCalls {
    ...
    #[automatically_derived]
    impl AllocationManagerStorageCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for AllocationManagerStorageCalls {
        const NAME: &'static str = "AllocationManagerStorageCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<AllocationManagerStorageCalls>] = &[
                {
                    fn slashOperator(
                        data: &[u8],
                        validate: bool,
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::slashOperator)
                    }
                    slashOperator
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::getAllocation)
                    }
                    getAllocation
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::modifyAllocations)
                    }
                    modifyAllocations
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::getAllocatedSets)
                    }
                    getAllocatedSets
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::isOperatorSet)
                    }
                    isOperatorSet
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::DEALLOCATION_DELAY)
                    }
                    DEALLOCATION_DELAY
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::getMinimumSlashableStake)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::getAVSRegistrar)
                    }
                    getAVSRegistrar
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::getStrategyAllocations)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        <getStrategiesInOperatorSetCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                AllocationManagerStorageCalls::getStrategiesInOperatorSet,
                            )
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::getMaxMagnitudes_0)
                    }
                    getMaxMagnitudes_0
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::clearDeallocationQueue)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::getMaxMagnitudes_1)
                    }
                    getMaxMagnitudes_1
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::setAllocationDelay_0)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::setAllocationDelay_1)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::getAllocatableMagnitude)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        <deregisterFromOperatorSetsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                AllocationManagerStorageCalls::deregisterFromOperatorSets,
                            )
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        <getMembersCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(AllocationManagerStorageCalls::getMembers)
                    }
                    getMembers
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        <addStrategiesToOperatorSetCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                AllocationManagerStorageCalls::addStrategiesToOperatorSet,
                            )
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::getRegisteredSets)
                    }
                    getRegisteredSets
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        <ALLOCATION_CONFIGURATION_DELAYCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                AllocationManagerStorageCalls::ALLOCATION_CONFIGURATION_DELAY,
                            )
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::createOperatorSets)
                    }
                    createOperatorSets
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::getAllocations)
                    }
                    getAllocations
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::getMaxMagnitudesAtBlock)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::getMaxMagnitude)
                    }
                    getMaxMagnitude
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::encumberedMagnitude)
                    }
                    encumberedMagnitude
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::updateAVSMetadataURI)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::getMemberCount)
                    }
                    getMemberCount
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::registerForOperatorSets)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::getAllocationDelay)
                    }
                    getAllocationDelay
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::getAllocatedStrategies)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        <initializeCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(AllocationManagerStorageCalls::initialize)
                    }
                    initialize
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        <removeStrategiesFromOperatorSetCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                AllocationManagerStorageCalls::removeStrategiesFromOperatorSet,
                            )
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        <delegationCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(AllocationManagerStorageCalls::delegation)
                    }
                    delegation
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageCalls>
                    {
                        ...
                        .map(AllocationManagerStorageCalls::setAVSRegistrar)
                    }
                    setAVSRegistrar
                },
            ];
    ...
    ///Container for all the [`AllocationManagerStorage`](self) custom errors.
    pub enum AllocationManagerStorageErrors {
    ...
    #[automatically_derived]
    impl AllocationManagerStorageErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for AllocationManagerStorageErrors {
        const NAME: &'static str = "AllocationManagerStorageErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                AllocationManagerStorageErrors,
            >] = &[
                {
                    fn SignatureExpired(
                        data: &[u8],
                        validate: bool,
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        <SignatureExpired as alloy_sol_types::SolError>::abi_decode_raw(
                            data, validate,
                        )
                        .map(AllocationManagerStorageErrors::SignatureExpired)
                    }
                    SignatureExpired
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        ...
                        .map(AllocationManagerStorageErrors::InvalidWadToSlash)
                    }
                    InvalidWadToSlash
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        ...
                        .map(AllocationManagerStorageErrors::NotMemberOfSet)
                    }
                    NotMemberOfSet
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        ...
                        .map(AllocationManagerStorageErrors::OperatorNotRegistered)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        ...
                        .map(AllocationManagerStorageErrors::InputArrayLengthMismatch)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        <InvalidCaller as alloy_sol_types::SolError>::abi_decode_raw(data, validate)
                            .map(AllocationManagerStorageErrors::InvalidCaller)
                    }
                    InvalidCaller
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        ...
                        .map(AllocationManagerStorageErrors::InvalidStrategy)
                    }
                    InvalidStrategy
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        ...
                        .map(AllocationManagerStorageErrors::InvalidBlockNumber)
                    }
                    InvalidBlockNumber
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        ...
                        .map(AllocationManagerStorageErrors::StrategyAlreadyInOperatorSet)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        ...
                        .map(AllocationManagerStorageErrors::StrategyNotInOperatorSet)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        ...
                        .map(AllocationManagerStorageErrors::InsufficientMagnitude)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        ...
                        .map(AllocationManagerStorageErrors::InvalidOperatorSet)
                    }
                    InvalidOperatorSet
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        ...
                        .map(AllocationManagerStorageErrors::InvalidSignature)
                    }
                    InvalidSignature
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        <SameMagnitude as alloy_sol_types::SolError>::abi_decode_raw(data, validate)
                            .map(AllocationManagerStorageErrors::SameMagnitude)
                    }
                    SameMagnitude
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        ...
                        .map(AllocationManagerStorageErrors::InvalidOperator)
                    }
                    InvalidOperator
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        ...
                        .map(AllocationManagerStorageErrors::AlreadyMemberOfSet)
                    }
                    AlreadyMemberOfSet
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        ...
                        .map(AllocationManagerStorageErrors::ModificationAlreadyPending)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        ...
                        .map(AllocationManagerStorageErrors::OperatorNotSlashable)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        ...
                        .map(AllocationManagerStorageErrors::OnlyDelegationManager)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<AllocationManagerStorageErrors>
                    {
                        ...
                        .map(AllocationManagerStorageErrors::UninitializedAllocationDelay)
                    }
    ...
    ///Container for all the [`AllocationManagerStorage`](self) events.
    pub enum AllocationManagerStorageEvents {
    ...
    #[automatically_derived]
    impl AllocationManagerStorageEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for AllocationManagerStorageEvents {
        const NAME: &'static str = "AllocationManagerStorageEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for AllocationManagerStorageEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`AllocationManagerStorage`](self) contract instance.

    See the [wrapper's documentation](`AllocationManagerStorageInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> AllocationManagerStorageInstance<T, P, N> {
        AllocationManagerStorageInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        ...
        Output = alloy_contract::Result<AllocationManagerStorageInstance<T, P, N>>,
    > {
        AllocationManagerStorageInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        AllocationManagerStorageInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`AllocationManagerStorage`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`AllocationManagerStorage`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct AllocationManagerStorageInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for AllocationManagerStorageInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("AllocationManagerStorageInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        > AllocationManagerStorageInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<AllocationManagerStorageInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> AllocationManagerStorageInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> AllocationManagerStorageInstance<T, P, N> {
            AllocationManagerStorageInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
