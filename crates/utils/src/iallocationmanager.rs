            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<IAllocationManagerCalls>] = &[
                {
                    fn getAllocationInfo_0(
                        ...
                        .map(IAllocationManagerCalls::getAllocationInfo_0)
                    }
                    getAllocationInfo_0
                },
                {
                ...
                },
                {
                    fn getAllocationInfo_1(
                        ...
                        .map(IAllocationManagerCalls::getAllocationInfo_1)
                    }
                    getAllocationInfo_1
                },
                {
                ...
                },
                {
                    fn getAllocationInfo_2(
                        ...
                        .map(IAllocationManagerCalls::getAllocationInfo_2)
                    }
                    getAllocationInfo_2
                },
                {
                    fn getMaxMagnitudes(
                        ...
                        .map(IAllocationManagerCalls::getMaxMagnitudes)
                    }
                    getMaxMagnitudes
                },
                {
                ...
                },
                {
                    fn getMaxMagnitudesAtTimestamp(
                        ...
                        <getMaxMagnitudesAtTimestampCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IAllocationManagerCalls::getMaxMagnitudesAtTimestamp)
                    }
                ...
                },
                {
                    fn getMinDelegatedAndSlashableOperatorShares(
                        ...
                        <getMinDelegatedAndSlashableOperatorSharesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                IAllocationManagerCalls::getMinDelegatedAndSlashableOperatorShares,
                            )
                    }
            ...
            static DECODE_SHIMS: &[fn(
                ...
                },
                {
                    fn SaltSpent(
                        ...
                        <SaltSpent as alloy_sol_types::SolError>::abi_decode_raw(data, validate)
                            .map(IAllocationManagerErrors::SaltSpent)
                    }
                    SaltSpent
                },
                {
                ...
                },
                {
                    fn OperatorNotAllocated(
                        ...
                        .map(IAllocationManagerErrors::OperatorNotAllocated)
                    }
                ...
                },
                {
                    fn AlreadySlashedForTimestamp(
                        ...
                        .map(IAllocationManagerErrors::AlreadySlashedForTimestamp)
                    }
                ...
                },
                {
                    fn InvalidTimestamp(
                        ...
                        .map(IAllocationManagerErrors::InvalidTimestamp)
                    }
                    InvalidTimestamp
                },
                {
                    fn InsufficientAllocatableMagnitude(
                        ...
                        <InsufficientAllocatableMagnitude as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                IAllocationManagerErrors::InsufficientAllocatableMagnitude,
                            )
                    }
                ...
                },
                {
                    fn InvalidAllocationDelay(
                        ...
                        .map(IAllocationManagerErrors::InvalidAllocationDelay)
                    }
                ...
                },
                {
                    fn InvalidExpectedTotalMagnitude(
                        ...
                        <InvalidExpectedTotalMagnitude as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IAllocationManagerErrors::InvalidExpectedTotalMagnitude)
                    }
