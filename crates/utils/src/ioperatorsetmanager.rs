...
interface IOperatorSetManager {
    ...
    event SlashableMagnitudeUpdated(address operator, address strategy, OperatorSet operatorSet, uint64 slashableMagnitude, uint32 effectEpoch);
    event TotalMagnitudeUpdated(address operator, address strategy, uint64 totalMagnitude, uint32 effectEpoch);

    function getSlashableBips(address operator, OperatorSet memory operatorSet, address strategy, uint32 epoch) external view returns (uint16 slashableBips);
    function updateSlashingParameters(address operator, SlashingMagnitudeParameters[] memory slashingMagnitudeParameters, ISignatureUtils.SignatureWithExpiry memory allocatorSignature) external returns (uint32 effectEpoch);
}
```
...
```*/
    ...
    pub struct updateSlashingParametersCall {
        ...
        pub slashingMagnitudeParameters: alloy::sol_types::private::Vec<
            <SlashingMagnitudeParameters as alloy::sol_types::SolType>::RustType,
        >,
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            type UnderlyingSolTuple<'a> = (
                alloy::sol_types::sol_data::Address,
                alloy::sol_types::sol_data::Array<SlashingMagnitudeParameters>,
    ...
    ///Container for all the [`IOperatorSetManager`](self) function calls.
    pub enum IOperatorSetManagerCalls {
        getSlashableBips(getSlashableBipsCall),
        updateSlashingParameters(updateSlashingParametersCall),
    }
    #[automatically_derived]
    impl IOperatorSetManagerCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IOperatorSetManagerCalls {
        const NAME: &'static str = "IOperatorSetManagerCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IOperatorSetManagerCalls>] = &[
                {
                    fn getSlashableBips(
                        data: &[u8],
                        validate: bool,
                        ...
                        <getSlashableBipsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IOperatorSetManagerCalls::getSlashableBips)
                    }
                    getSlashableBips
                },
                {
                    fn updateSlashingParameters(
                        ...
                        <updateSlashingParametersCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IOperatorSetManagerCalls::updateSlashingParameters)
                    }
    ...
    ///Container for all the [`IOperatorSetManager`](self) events.
    pub enum IOperatorSetManagerEvents {
        SlashableMagnitudeUpdated(SlashableMagnitudeUpdated),
        TotalMagnitudeUpdated(TotalMagnitudeUpdated),
    }
    #[automatically_derived]
    impl IOperatorSetManagerEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IOperatorSetManagerEvents {
        const NAME: &'static str = "IOperatorSetManagerEvents";
        const COUNT: usize = 2usize;
        fn decode_raw_log(
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IOperatorSetManagerEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IOperatorSetManagerInstance<T, P, N>>,
    > {
        IOperatorSetManagerInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IOperatorSetManagerInstance::<T, P, N>::deploy_builder(provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IOperatorSetManagerInstance<T, P, N>> {
