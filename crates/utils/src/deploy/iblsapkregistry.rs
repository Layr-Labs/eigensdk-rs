...
pub mod IBLSApkRegistry {
    ...
    const _: () = {
        ...
        }
        {
            ...
            #[doc(hidden)]
            type UnderlyingRustTuple<'a> = (<ApkUpdate as alloy::sol_types::SolType>::RustType,);
            #[cfg(test)]
            #[allow(dead_code, unreachable_patterns)]
            fn _type_assertion(_t: alloy_sol_types::private::AssertTypeEq<UnderlyingRustTuple>) {
                match _t {
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IBLSApkRegistryInstance<T, P, N>>>
    {
