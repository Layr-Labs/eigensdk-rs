...
<<<<<<< HEAD:crates/utils/src/istrategymanager.rs
=======
    function domainSeparator() external view returns (bytes32);
    function eigenPodManager() external view returns (address);
>>>>>>> dev:crates/utils/src/deploy/istrategymanager.rs
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<IStrategyManagerCalls>] = &[
                {
                    fn initialize(
                        ...
                        <initializeCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IStrategyManagerCalls::initialize)
                    }
                    initialize
                },
                {
                ...
                },
                {
                    fn setThirdPartyTransfersForbidden(
                        ...
                        <setThirdPartyTransfersForbiddenCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IStrategyManagerCalls::setThirdPartyTransfersForbidden)
                    }
                ...
                },
                {
                    fn removeDepositShares(
                        ...
                        .map(IStrategyManagerCalls::removeDepositShares)
                    }
                    removeDepositShares
                },
                {
                ...
                },
                {
                    fn calculateStrategyDepositDigestHash(
                        ...
                        <calculateStrategyDepositDigestHashCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                IStrategyManagerCalls::calculateStrategyDepositDigestHash,
                            )
                    }
                ...
                },
                {
                    fn setStrategyWhitelister(
                        ...
                        .map(IStrategyManagerCalls::setStrategyWhitelister)
                    }
...
>>>>>>> dev:crates/utils/src/deploy/istrategymanager.rs
                        ...
                        .map(IStrategyManagerCalls::getStakerStrategyList)
                    }
...
<<<<<<< HEAD:crates/utils/src/istrategymanager.rs
                    fn burnShares(
                        ...
                        <burnSharesCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IStrategyManagerCalls::burnShares)
                    }
                    burnShares
                },
                {
                    fn stakerDepositShares(
                        ...
                        .map(IStrategyManagerCalls::stakerDepositShares)
                    }
                    stakerDepositShares
=======
                    fn domainSeparator(
                        ...
                        .map(IStrategyManagerCalls::domainSeparator)
                    }
                    domainSeparator
>>>>>>> dev:crates/utils/src/deploy/istrategymanager.rs
                },
...
>>>>>>> dev:crates/utils/src/deploy/istrategymanager.rs
    ...
    ///Container for all the [`IStrategyManager`](self) custom errors.
    pub enum IStrategyManagerErrors {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IStrategyManagerErrors {
        const NAME: &'static str = "IStrategyManagerErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<IStrategyManagerErrors>] = &[
                {
                    fn MaxStrategiesExceeded(
                        ...
                        .map(IStrategyManagerErrors::MaxStrategiesExceeded)
                    }
                ...
                },
                {
                    fn StakerAddressZero(
                        ...
                        .map(IStrategyManagerErrors::StakerAddressZero)
                    }
                    StakerAddressZero
                },
                {
                    fn SharesAmountTooHigh(
                        ...
                        .map(IStrategyManagerErrors::SharesAmountTooHigh)
                    }
                    SharesAmountTooHigh
                },
                {
                    fn StrategyNotFound(
                        ...
                        .map(IStrategyManagerErrors::StrategyNotFound)
                    }
                    StrategyNotFound
                },
                {
                    fn StrategyNotWhitelisted(
                        ...
                        .map(IStrategyManagerErrors::StrategyNotWhitelisted)
                    }
                ...
                },
                {
                    fn OnlyStrategyWhitelister(
                        ...
                        .map(IStrategyManagerErrors::OnlyStrategyWhitelister)
                    }
                ...
                },
                {
                    fn SharesAmountZero(
                        ...
                        .map(IStrategyManagerErrors::SharesAmountZero)
                    }
                    SharesAmountZero
                },
                {
                    fn OnlyDelegationManager(
                        ...
                        .map(IStrategyManagerErrors::OnlyDelegationManager)
                    }
