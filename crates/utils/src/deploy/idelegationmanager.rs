...
<<<<<<< HEAD:crates/utils/src/idelegationmanager.rs
...
>>>>>>> dev:crates/utils/src/deploy/idelegationmanager.rs
...
=======
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolEvent for WithdrawalQueued {
            type DataTuple<'a> = (alloy::sol_types::sol_data::FixedBytes<32>, Withdrawal);
            type DataToken<'a> = <Self::DataTuple<'a> as alloy_sol_types::SolType>::Token<'a>;
            type TopicList = (alloy_sol_types::sol_data::FixedBytes<32>,);
...
>>>>>>> dev:crates/utils/src/deploy/idelegationmanager.rs
                ...
                },
                {
                    fn getSlashableSharesInQueue(
                        ...
                        .map(IDelegationManagerCalls::getSlashableSharesInQueue)
                    }
                ...
                },
                {
                    fn redelegate(
                        ...
                        <redelegateCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IDelegationManagerCalls::redelegate)
                    }
                    redelegate
                },
                {
                ...
                },
                {
                    fn burnOperatorShares(
                        ...
                        .map(IDelegationManagerCalls::burnOperatorShares)
                    }
                    burnOperatorShares
                },
                {
...
=======
        ...
        pub fn strategyWithdrawalDelayBlocks(
            ...
            self.call_builder(&strategyWithdrawalDelayBlocksCall { strategy })
        }
>>>>>>> dev:crates/utils/src/deploy/idelegationmanager.rs
