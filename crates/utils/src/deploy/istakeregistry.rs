...
interface IStakeRegistry {
    ...
    function initializeDelegatedStakeQuorum(uint8 quorumNumber, uint96 minimumStake, StrategyParams[] memory _strategyParams) external;
    function initializeSlashableStakeQuorum(uint8 quorumNumber, uint96 minimumStake, uint32 lookAheadPeriod, StrategyParams[] memory _strategyParams) external;
...
<<<<<<< HEAD:crates/utils/src/istakeregistry.rs
...
>>>>>>> dev:crates/utils/src/deploy/istakeregistry.rs
    #[allow(
        non_camel_case_types,
        non_snake_case,
        clippy::pub_underscore_fields,
