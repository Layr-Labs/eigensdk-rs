...
```solidity
interface PermissionControllerMixin {
...
<<<<<<<< HEAD:crates/utils/src/permissioncontrollermixin.rs
pub mod PermissionControllerMixin {
========
pub mod EigenlayerContractsParser {
>>>>>>>> dev:crates/utils/src/deploy/eigenlayercontractsparser.rs
    use super::*;
...
>>>>>>>> dev:crates/utils/src/deploy/eigenlayercontractsparser.rs
    ...
    ///Container for all the [`PermissionControllerMixin`](self) function calls.
    pub enum PermissionControllerMixinCalls {
        permissionController(permissionControllerCall),
    }
    #[automatically_derived]
    impl PermissionControllerMixinCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[70u8, 87u8, 226u8, 106u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for PermissionControllerMixinCalls {
        const NAME: &'static str = "PermissionControllerMixinCalls";
    ...
    ///Container for all the [`PermissionControllerMixin`](self) custom errors.
    pub enum PermissionControllerMixinErrors {
        InvalidPermissions(InvalidPermissions),
    }
    #[automatically_derived]
    impl PermissionControllerMixinErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
        ///
        /// Prefer using `SolInterface` methods instead.
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[147u8, 45u8, 148u8, 247u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for PermissionControllerMixinErrors {
        const NAME: &'static str = "PermissionControllerMixinErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        const COUNT: usize = 1usize;
        #[inline]
        fn selector(&self) -> [u8; 4] {
    ...
    >(
        ...
        PermissionControllerMixinInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        ...
        Output = alloy_contract::Result<PermissionControllerMixinInstance<T, P, N>>,
    > {
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for PermissionControllerMixinInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("PermissionControllerMixinInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        > PermissionControllerMixinInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<PermissionControllerMixinInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> PermissionControllerMixinInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> PermissionControllerMixinInstance<T, P, N> {
            PermissionControllerMixinInstance {
