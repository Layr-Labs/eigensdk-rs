...
<<<<<<< HEAD:crates/utils/src/stakeregistrystorage.rs
...
>>>>>>> dev:crates/utils/src/deploy/stakeregistrystorage.rs
    #[allow(
        non_camel_case_types,
        non_snake_case,
        clippy::pub_underscore_fields,
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct StakeRegistryStorageInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    ...
    impl<T, P, N> ::core::fmt::Debug for StakeRegistryStorageInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("StakeRegistryStorageInstance")
                .field(&self.address)
                .finish()
        }
    }
