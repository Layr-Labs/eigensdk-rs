...
```*/
    ...
    ///Container for all the [`IServiceManagerUI`](self) function calls.
    pub enum IServiceManagerUICalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IServiceManagerUICalls {
        const NAME: &'static str = "IServiceManagerUICalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IServiceManagerUICalls>] = &[
                {
                    fn getOperatorRestakedStrategies(
                        ...
                        <getOperatorRestakedStrategiesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IServiceManagerUICalls::getOperatorRestakedStrategies)
                    }
                ...
                },
                {
                    fn avsDirectory(
                        ...
                        <avsDirectoryCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IServiceManagerUICalls::avsDirectory)
                    }
                    avsDirectory
                },
                {
                    fn registerOperatorToAVS(
                        ...
                        <registerOperatorToAVSCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IServiceManagerUICalls::registerOperatorToAVS)
                    }
                ...
                },
                {
                    fn deregisterOperatorFromAVS(
                        ...
                        <deregisterOperatorFromAVSCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IServiceManagerUICalls::deregisterOperatorFromAVS)
                    }
                ...
                },
                {
                    fn updateAVSMetadataURI(
                        ...
                        <updateAVSMetadataURICall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IServiceManagerUICalls::updateAVSMetadataURI)
                    }
                ...
                },
                {
                    fn allocationManager(
                        ...
                        <allocationManagerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IServiceManagerUICalls::allocationManager)
                    }
                    allocationManager
                },
                {
                    fn getRestakeableStrategies(
                        ...
                        <getRestakeableStrategiesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IServiceManagerUICalls::getRestakeableStrategies)
                    }
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`IServiceManagerUI`](self) contract instance.

See the [wrapper's documentation](`IServiceManagerUIInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IServiceManagerUIInstance<T, P, N> {
        IServiceManagerUIInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IServiceManagerUIInstance<T, P, N>>,
    > {
        IServiceManagerUIInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IServiceManagerUIInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IServiceManagerUI`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IServiceManagerUI`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IServiceManagerUIInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IServiceManagerUIInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IServiceManagerUIInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    #[automatically_derived]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IServiceManagerUIInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IServiceManagerUIInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IServiceManagerUIInstance<T, P, N> {
            IServiceManagerUIInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
