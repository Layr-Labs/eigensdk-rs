...
pub mod MockAvsContractsParser {
    ...
    ///
    /// ```text
    
    /// ```
    #[rustfmt::skip]
    #[allow(clippy::all)]
    pub static BYTECODE: alloy_sol_types::private::Bytes = alloy_sol_types::private::Bytes::from_static(
        b"`\x80`@R`\x0C\x80Tb\xFF\0\xFF\x19\x16b\x01\0\x01\x17\x90U4\x80\x15`\x1FW__\xFD[P`\x86\x80`+_9_\xF3\xFE`\x80`@R4\x80\x15`\x0EW__\xFD[P`\x046\x10`&W_5`\xE0\x1C\x80c\xF8\xCC\xBFG\x14`*W[__\xFD[`\x0CT`<\x90b\x01\0\0\x90\x04`\xFF\x16\x81V[`@Q\x90\x15\x15\x81R` \x01`@Q\x80\x91\x03\x90\xF3\xFE\xA2dipfsX\"\x12 3\xFAD\xA7\xA2y:\xF7J\xFC\xDC\xA0\x0C\x10v\xCFu8N_\n\x86Z\xB3\x05n\x91\nKQ\xE5FdsolcC\0\x08\x1C\x003",
    );
    /// The runtime bytecode of the contract, as deployed on the network.
    ///
    /// ```text
    
    /// ```
    #[rustfmt::skip]
    #[allow(clippy::all)]
    pub static DEPLOYED_BYTECODE: alloy_sol_types::private::Bytes = alloy_sol_types::private::Bytes::from_static(
        b"`\x80`@R4\x80\x15`\x0EW__\xFD[P`\x046\x10`&W_5`\xE0\x1C\x80c\xF8\xCC\xBFG\x14`*W[__\xFD[`\x0CT`<\x90b\x01\0\0\x90\x04`\xFF\x16\x81V[`@Q\x90\x15\x15\x81R` \x01`@Q\x80\x91\x03\x90\xF3\xFE\xA2dipfsX\"\x12 3\xFAD\xA7\xA2y:\xF7J\xFC\xDC\xA0\x0C\x10v\xCFu8N_\n\x86Z\xB3\x05n\x91\nKQ\xE5FdsolcC\0\x08\x1C\x003",
    );
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct MockAvsContractsParserInstance<
        T,
        P,
    ...
    impl<T, P, N> ::core::fmt::Debug for MockAvsContractsParserInstance<T, P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("MockAvsContractsParserInstance").field(&self.address).finish()
        }
    }
