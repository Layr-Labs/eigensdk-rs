...
interface MockRewardsCoordinator {
    function createAVSRewardsSubmission(address avs, IRewardsCoordinatorTypes.RewardsSubmission[] memory) external pure;
}
```
...
pub mod MockRewardsCoordinator {
    ...
    ///
    /// ```text
    
    /// ```
    #[rustfmt::skip]
    #[allow(clippy::all)]
    pub static BYTECODE: alloy_sol_types::private::Bytes = alloy_sol_types::private::Bytes::from_static(
        b"`\x80`@R4\x80\x15`\x0EW__\xFD[Pa\x01\xA4\x80a\0\x1C_9_\xF3\xFE`\x80`@R4\x80\x15a\0\x0FW__\xFD[P`\x046\x10a\0)W_5`\xE0\x1C\x80cC\xEADv\x14a\0-W[__\xFD[a\0G`\x04\x806\x03\x81\x01\x90a\0B\x91\x90a\x01\x11V[a\0IV[\0[PPPV[__\xFD[__\xFD[_s\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x82\x16\x90P\x91\x90PV[_a\0\x7F\x82a\0VV[\x90P\x91\x90PV[a\0\x8F\x81a\0uV[\x81\x14a\0\x99W__\xFD[PV[_\x815\x90Pa\0\xAA\x81a\0\x86V[\x92\x91PPV[__\xFD[__\xFD[__\xFD[__\x83`\x1F\x84\x01\x12a\0\xD1Wa\0\xD0a\0\xB0V[[\x825\x90Pg\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x81\x11\x15a\0\xEEWa\0\xEDa\0\xB4V[[` \x83\x01\x91P\x83` \x82\x02\x83\x01\x11\x15a\x01\nWa\x01\ta\0\xB8V[[\x92P\x92\x90PV[___`@\x84\x86\x03\x12\x15a\x01(Wa\x01'a\0NV[[_a\x015\x86\x82\x87\x01a\0\x9CV[\x93PP` \x84\x015g\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x81\x11\x15a\x01VWa\x01Ua\0RV[[a\x01b\x86\x82\x87\x01a\0\xBCV[\x92P\x92PP\x92P\x92P\x92V\xFE\xA2dipfsX\"\x12 \x1D~\xC4\xE0\x98!\"\x1C\x92]\r\xE0\xF7o\x8F(\xD6\xC6\xB5x\xE3Wb6\xCAJ\x84W\x84.\xE3WdsolcC\0\x08\x1B\x003",
    );
    /// The runtime bytecode of the contract, as deployed on the network.
    ///
    /// ```text
    
    /// ```
    #[rustfmt::skip]
    #[allow(clippy::all)]
    pub static DEPLOYED_BYTECODE: alloy_sol_types::private::Bytes = alloy_sol_types::private::Bytes::from_static(
        b"`\x80`@R4\x80\x15a\0\x0FW__\xFD[P`\x046\x10a\0)W_5`\xE0\x1C\x80cC\xEADv\x14a\0-W[__\xFD[a\0G`\x04\x806\x03\x81\x01\x90a\0B\x91\x90a\x01\x11V[a\0IV[\0[PPPV[__\xFD[__\xFD[_s\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x82\x16\x90P\x91\x90PV[_a\0\x7F\x82a\0VV[\x90P\x91\x90PV[a\0\x8F\x81a\0uV[\x81\x14a\0\x99W__\xFD[PV[_\x815\x90Pa\0\xAA\x81a\0\x86V[\x92\x91PPV[__\xFD[__\xFD[__\xFD[__\x83`\x1F\x84\x01\x12a\0\xD1Wa\0\xD0a\0\xB0V[[\x825\x90Pg\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x81\x11\x15a\0\xEEWa\0\xEDa\0\xB4V[[` \x83\x01\x91P\x83` \x82\x02\x83\x01\x11\x15a\x01\nWa\x01\ta\0\xB8V[[\x92P\x92\x90PV[___`@\x84\x86\x03\x12\x15a\x01(Wa\x01'a\0NV[[_a\x015\x86\x82\x87\x01a\0\x9CV[\x93PP` \x84\x015g\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x81\x11\x15a\x01VWa\x01Ua\0RV[[a\x01b\x86\x82\x87\x01a\0\xBCV[\x92P\x92PP\x92P\x92P\x92V\xFE\xA2dipfsX\"\x12 \x1D~\xC4\xE0\x98!\"\x1C\x92]\r\xE0\xF7o\x8F(\xD6\xC6\xB5x\xE3Wb6\xCAJ\x84W\x84.\xE3WdsolcC\0\x08\x1B\x003",
    );
...
```*/
    ...
    ///Container for all the [`MockRewardsCoordinator`](self) function calls.
    pub enum MockRewardsCoordinatorCalls {
        createAVSRewardsSubmission(createAVSRewardsSubmissionCall),
    }
    #[automatically_derived]
    impl MockRewardsCoordinatorCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[67u8, 234u8, 68u8, 118u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for MockRewardsCoordinatorCalls {
        const NAME: &'static str = "MockRewardsCoordinatorCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<MockRewardsCoordinatorCalls>] = &[
                {
                    fn createAVSRewardsSubmission(
                        ...
                        <createAVSRewardsSubmissionCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(MockRewardsCoordinatorCalls::createAVSRewardsSubmission)
                    }
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`MockRewardsCoordinator`](self) contract instance.

See the [wrapper's documentation](`MockRewardsCoordinatorInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> MockRewardsCoordinatorInstance<T, P, N> {
        MockRewardsCoordinatorInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<MockRewardsCoordinatorInstance<T, P, N>>,
    > {
        MockRewardsCoordinatorInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        MockRewardsCoordinatorInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`MockRewardsCoordinator`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`MockRewardsCoordinator`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct MockRewardsCoordinatorInstance<
        T,
        P,
        N = alloy_contract::private::Ethereum,
    > {
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for MockRewardsCoordinatorInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("MockRewardsCoordinatorInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    #[automatically_derived]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<MockRewardsCoordinatorInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> MockRewardsCoordinatorInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> MockRewardsCoordinatorInstance<T, P, N> {
            MockRewardsCoordinatorInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
    ...
    > MockRewardsCoordinatorInstance<T, P, N> {
        ...
        pub fn createAVSRewardsSubmission(
            ...
            _1: alloy::sol_types::private::Vec<
                <IRewardsCoordinatorTypes::RewardsSubmission as alloy::sol_types::SolType>::RustType,
            >,
