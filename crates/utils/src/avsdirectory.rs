...
pub mod AVSDirectory {
    ...
    {
        AVSDirectoryInstance::<T, P, N>::deploy(provider, _delegation, _DEALLOCATION_DELAY)
    }
    ...
    >(
        ...
        AVSDirectoryInstance::<T, P, N>::deploy_builder(provider, _delegation, _DEALLOCATION_DELAY)
    }
        ...
        > AVSDirectoryInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            ...
            let call_builder = Self::deploy_builder(provider, _delegation, _DEALLOCATION_DELAY);
        ...
        > AVSDirectoryInstance<T, P, N>
    {
        ...
        pub fn operatorSetStatus(
            ...
            self.call_builder(&operatorSetStatusCall { _0, _1, _2 })
        }
