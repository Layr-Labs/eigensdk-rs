...
pub mod IAllocationManagerTypes {
    ...
    >(
        ...
        Output = alloy_contract::Result<IAllocationManagerTypesInstance<T, P, N>>,
    > {
        IAllocationManagerTypesInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IAllocationManagerTypesInstance::<T, P, N>::deploy_builder(provider)
    }
        ...
        > IAllocationManagerTypesInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IAllocationManagerTypesInstance<T, P, N>> {
