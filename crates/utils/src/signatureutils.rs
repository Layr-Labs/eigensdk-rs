...
```*/
    ...
    ///Container for all the [`SignatureUtils`](self) function calls.
    pub enum SignatureUtilsCalls {
        domainSeparator(domainSeparatorCall),
    }
    #[automatically_derived]
    impl SignatureUtilsCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[246u8, 152u8, 218u8, 37u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for SignatureUtilsCalls {
        const NAME: &'static str = "SignatureUtilsCalls";
    ...
    ///Container for all the [`SignatureUtils`](self) custom errors.
    pub enum SignatureUtilsErrors {
        InvalidSignature(InvalidSignature),
        SignatureExpired(SignatureExpired),
    }
    #[automatically_derived]
    impl SignatureUtilsErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    impl alloy_sol_types::SolInterface for SignatureUtilsErrors {
        const NAME: &'static str = "SignatureUtilsErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
...
See the [wrapper's documentation](`SignatureUtilsInstance`) for more details.*/
    ...
    >(
        ...
        SignatureUtilsInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<SignatureUtilsInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> SignatureUtilsInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> SignatureUtilsInstance<T, P, N> {
            SignatureUtilsInstance {
