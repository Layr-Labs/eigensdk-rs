...
pub mod IDelegationManager {
            ...
            static DECODE_SHIMS: &[fn(
                ...
                },
                {
                    fn getCompletableTimestamp(
                        ...
                        .map(IDelegationManagerCalls::getCompletableTimestamp)
                    }
            ...
            static DECODE_SHIMS: &[fn(
                ...
                },
                {
                    fn AllocationDelaySet(
                        ...
                        .map(IDelegationManagerErrors::AllocationDelaySet)
                    }
                    AllocationDelaySet
                },
                {
                ...
                },
                {
                    fn WithdrawalDelayExceedsMax(
                        ...
                        .map(IDelegationManagerErrors::WithdrawalDelayExceedsMax)
                    }
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IDelegationManagerInstance<T, P, N>>>
    {
