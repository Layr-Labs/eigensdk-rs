...
pub mod EigenPodStorage {
    ...
    ///Container for all the [`EigenPodStorage`](self) function calls.
    pub enum EigenPodStorageCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for EigenPodStorageCalls {
        const NAME: &'static str = "EigenPodStorageCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<EigenPodStorageCalls>] = &[
                {
                    fn verifyStaleBalance(
                        ...
                        .map(EigenPodStorageCalls::verifyStaleBalance)
                    }
                    verifyStaleBalance
                },
                {
                    fn podOwner(
                        ...
                        <podOwnerCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(EigenPodStorageCalls::podOwner)
                    }
                    podOwner
                },
                {
                    fn activeValidatorCount(
                        ...
                        .map(EigenPodStorageCalls::activeValidatorCount)
                    }
                ...
                },
                {
                    fn withdrawableRestakedExecutionLayerGwei(
                        ...
                        <withdrawableRestakedExecutionLayerGweiCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                EigenPodStorageCalls::withdrawableRestakedExecutionLayerGwei,
                            )
                    }
                ...
                },
                {
                    fn verifyWithdrawalCredentials(
                        ...
                        <verifyWithdrawalCredentialsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(EigenPodStorageCalls::verifyWithdrawalCredentials)
                    }
                ...
                },
                {
                    fn currentCheckpointTimestamp(
                        ...
                        <currentCheckpointTimestampCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(EigenPodStorageCalls::currentCheckpointTimestamp)
                    }
                ...
                },
                {
                    fn eigenPodManager(
                        ...
                        .map(EigenPodStorageCalls::eigenPodManager)
                    }
                    eigenPodManager
                },
                {
                    fn currentCheckpoint(
                        ...
                        .map(EigenPodStorageCalls::currentCheckpoint)
                    }
                    currentCheckpoint
                },
                {
                    fn checkpointBalanceExitedGwei(
                        ...
                        <checkpointBalanceExitedGweiCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(EigenPodStorageCalls::checkpointBalanceExitedGwei)
                    }
                ...
                },
                {
                    fn proofSubmitter(
                        ...
                        .map(EigenPodStorageCalls::proofSubmitter)
                    }
                    proofSubmitter
                },
                {
                    fn validatorStatus_0(
                        ...
                        .map(EigenPodStorageCalls::validatorStatus_0)
                    }
                    validatorStatus_0
                },
                {
                    fn getParentBlockRoot(
                        ...
                        .map(EigenPodStorageCalls::getParentBlockRoot)
                    }
                    getParentBlockRoot
                },
                {
                    fn validatorPubkeyHashToInfo(
                        ...
                        .map(EigenPodStorageCalls::validatorPubkeyHashToInfo)
                    }
                ...
                },
                {
                    fn validatorStatus_1(
                        ...
                        .map(EigenPodStorageCalls::validatorStatus_1)
                    }
                    validatorStatus_1
                },
                {
                    fn startCheckpoint(
                        ...
                        .map(EigenPodStorageCalls::startCheckpoint)
                    }
                    startCheckpoint
                },
                {
                    fn stake(
                        ...
                        <stakeCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(EigenPodStorageCalls::stake)
                    }
                    stake
                },
                {
                    fn validatorPubkeyToInfo(
                        ...
                        .map(EigenPodStorageCalls::validatorPubkeyToInfo)
                    }
                ...
                },
                {
                    fn withdrawRestakedBeaconChainETH(
                        ...
                        <withdrawRestakedBeaconChainETHCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(EigenPodStorageCalls::withdrawRestakedBeaconChainETH)
                    }
                ...
                },
                {
                    fn initialize(
                        ...
                        <initializeCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(EigenPodStorageCalls::initialize)
                    }
                    initialize
                },
                {
                    fn setProofSubmitter(
                        ...
                        .map(EigenPodStorageCalls::setProofSubmitter)
                    }
                    setProofSubmitter
                },
                {
                    fn recoverTokens(
                        ...
                        .map(EigenPodStorageCalls::recoverTokens)
                    }
                    recoverTokens
                },
                {
                    fn lastCheckpointTimestamp(
                        ...
                        .map(EigenPodStorageCalls::lastCheckpointTimestamp)
                    }
                ...
                },
                {
                    fn verifyCheckpointProofs(
                        ...
                        .map(EigenPodStorageCalls::verifyCheckpointProofs)
                    }
    ...
    ///Container for all the [`EigenPodStorage`](self) custom errors.
    pub enum EigenPodStorageErrors {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for EigenPodStorageErrors {
        const NAME: &'static str = "EigenPodStorageErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        const COUNT: usize = 23usize;
        #[inline]
        fn selector(&self) -> [u8; 4] {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<EigenPodStorageErrors>] = &[
                {
                    fn InsufficientWithdrawableBalance(
                        ...
                        <InsufficientWithdrawableBalance as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(EigenPodStorageErrors::InsufficientWithdrawableBalance)
                    }
                ...
                },
                {
                    fn NoActiveCheckpoint(
                        ...
                        .map(EigenPodStorageErrors::NoActiveCheckpoint)
                    }
                    NoActiveCheckpoint
                },
                {
                    fn MsgValueNot32ETH(
                        ...
                        .map(EigenPodStorageErrors::MsgValueNot32ETH)
                    }
                    MsgValueNot32ETH
                },
                {
                    fn ValidatorIsExitingBeaconChain(
                        ...
                        <ValidatorIsExitingBeaconChain as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(EigenPodStorageErrors::ValidatorIsExitingBeaconChain)
                    }
                ...
                },
                {
                    fn CredentialsAlreadyVerified(
                        ...
                        .map(EigenPodStorageErrors::CredentialsAlreadyVerified)
                    }
                ...
                },
                {
                    fn BeaconTimestampTooFarInPast(
                        ...
                        .map(EigenPodStorageErrors::BeaconTimestampTooFarInPast)
                    }
                ...
                },
                {
                    fn OnlyEigenPodOwnerOrProofSubmitter(
                        ...
                        <OnlyEigenPodOwnerOrProofSubmitter as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                EigenPodStorageErrors::OnlyEigenPodOwnerOrProofSubmitter,
                            )
                    }
                ...
                },
                {
                    fn InputArrayLengthMismatch(
                        ...
                        .map(EigenPodStorageErrors::InputArrayLengthMismatch)
                    }
                ...
                },
                {
                    fn WithdrawCredentialsNotForEigenPod(
                        ...
                        <WithdrawCredentialsNotForEigenPod as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                EigenPodStorageErrors::WithdrawCredentialsNotForEigenPod,
                            )
                    }
                ...
                },
                {
                    fn InvalidEIP4788Response(
                        ...
                        .map(EigenPodStorageErrors::InvalidEIP4788Response)
                    }
                ...
                },
                {
                    fn ValidatorInactiveOnBeaconChain(
                        ...
                        <ValidatorInactiveOnBeaconChain as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(EigenPodStorageErrors::ValidatorInactiveOnBeaconChain)
                    }
                ...
                },
                {
                    fn CannotCheckpointTwiceInSingleBlock(
                        ...
                        <CannotCheckpointTwiceInSingleBlock as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                EigenPodStorageErrors::CannotCheckpointTwiceInSingleBlock,
                            )
                    }
                ...
                },
                {
                    fn InputAddressZero(
                        ...
                        .map(EigenPodStorageErrors::InputAddressZero)
                    }
                    InputAddressZero
                },
                {
                    fn CurrentlyPaused(
                        ...
                        .map(EigenPodStorageErrors::CurrentlyPaused)
                    }
                    CurrentlyPaused
                },
                {
                    fn AmountMustBeMultipleOfGwei(
                        ...
                        .map(EigenPodStorageErrors::AmountMustBeMultipleOfGwei)
                    }
                ...
                },
                {
                    fn InvalidPubKeyLength(
                        ...
                        .map(EigenPodStorageErrors::InvalidPubKeyLength)
                    }
                    InvalidPubKeyLength
                },
                {
                    fn ValidatorNotSlashedOnBeaconChain(
                        ...
                        <ValidatorNotSlashedOnBeaconChain as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(EigenPodStorageErrors::ValidatorNotSlashedOnBeaconChain)
                    }
                ...
                },
                {
                    fn CheckpointAlreadyActive(
                        ...
                        .map(EigenPodStorageErrors::CheckpointAlreadyActive)
                    }
                ...
                },
                {
                    fn OnlyEigenPodManager(
                        ...
                        .map(EigenPodStorageErrors::OnlyEigenPodManager)
                    }
                    OnlyEigenPodManager
                },
                {
                    fn NoBalanceToCheckpoint(
                        ...
                        .map(EigenPodStorageErrors::NoBalanceToCheckpoint)
                    }
                ...
                },
                {
                    fn ValidatorNotActiveInPod(
                        ...
                        .map(EigenPodStorageErrors::ValidatorNotActiveInPod)
                    }
                ...
                },
                {
                    fn OnlyEigenPodOwner(
                        ...
                        .map(EigenPodStorageErrors::OnlyEigenPodOwner)
                    }
                    OnlyEigenPodOwner
                },
                {
                    fn TimestampOutOfRange(
                        ...
                        .map(EigenPodStorageErrors::TimestampOutOfRange)
                    }
                    TimestampOutOfRange
                },
            ];
    ...
    ///Container for all the [`EigenPodStorage`](self) events.
    pub enum EigenPodStorageEvents {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for EigenPodStorageEvents {
        const NAME: &'static str = "EigenPodStorageEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for EigenPodStorageEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`EigenPodStorage`](self) contract instance.

    See the [wrapper's documentation](`EigenPodStorageInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> EigenPodStorageInstance<T, P, N> {
        EigenPodStorageInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<EigenPodStorageInstance<T, P, N>>>
    {
        EigenPodStorageInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        EigenPodStorageInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`EigenPodStorage`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`EigenPodStorage`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct EigenPodStorageInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for EigenPodStorageInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("EigenPodStorageInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        > EigenPodStorageInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<EigenPodStorageInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> EigenPodStorageInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> EigenPodStorageInstance<T, P, N> {
