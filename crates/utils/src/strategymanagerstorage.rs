...
pub mod StrategyManagerStorage {
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<StrategyManagerStorageErrors>] = &[
                {
                    fn SignatureExpired(
                        ...
                        .map(StrategyManagerStorageErrors::SignatureExpired)
                    }
                    SignatureExpired
                },
                {
    ...
    #[derive(Clone)]
    pub struct StrategyManagerStorageInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
    ...
    impl<T, P, N> ::core::fmt::Debug for StrategyManagerStorageInstance<T, P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("StrategyManagerStorageInstance")
                .field(&self.address)
                .finish()
        }
    }
