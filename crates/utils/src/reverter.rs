...
pub mod Reverter {
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<ReverterInstance<T, P, N>>>
    {
    ...
    impl<T, P, N> ::core::fmt::Debug for ReverterInstance<T, P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ReverterInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        > ReverterInstance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<ReverterInstance<T, P, N>> {
