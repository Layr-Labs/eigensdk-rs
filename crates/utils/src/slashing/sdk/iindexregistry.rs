        ...
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            for UnderlyingRustTuple<'_> {
                fn from(value: currentOperatorIndexCall) -> Self {
                    (value.quorumNumber, value.operatorId)
                }
            }
            #[automatically_derived]
            #[doc(hidden)]
...
```*/
    ...
    ///Container for all the [`IIndexRegistry`](self) function calls.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IIndexRegistryCalls {
        const NAME: &'static str = "IIndexRegistryCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IIndexRegistryCalls>] = &[
                {
                    fn registerOperator(
                        data: &[u8],
                        validate: bool,
                        ...
                        <registerOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IIndexRegistryCalls::registerOperator)
                    }
                    registerOperator
                },
                {
                    fn getLatestOperatorUpdate(
                        ...
                        <getLatestOperatorUpdateCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IIndexRegistryCalls::getLatestOperatorUpdate)
                    }
                ...
                },
                {
                    fn initializeQuorum(
                        ...
                        <initializeQuorumCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IIndexRegistryCalls::initializeQuorum)
                    }
                    initializeQuorum
                },
                {
                    fn getOperatorUpdateAtIndex(
                        ...
                        <getOperatorUpdateAtIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IIndexRegistryCalls::getOperatorUpdateAtIndex)
                    }
                ...
                },
                {
                    fn registryCoordinator(
                        ...
                        <registryCoordinatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IIndexRegistryCalls::registryCoordinator)
                    }
                    registryCoordinator
                },
                {
                    fn getLatestQuorumUpdate(
                        ...
                        <getLatestQuorumUpdateCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IIndexRegistryCalls::getLatestQuorumUpdate)
                    }
                ...
                },
                {
                    fn getOperatorListAtBlockNumber(
                        ...
                        <getOperatorListAtBlockNumberCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IIndexRegistryCalls::getOperatorListAtBlockNumber)
                    }
                ...
                },
                {
                    fn getQuorumUpdateAtIndex(
                        ...
                        <getQuorumUpdateAtIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IIndexRegistryCalls::getQuorumUpdateAtIndex)
                    }
                ...
                },
                {
                    fn deregisterOperator(
                        ...
                        <deregisterOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IIndexRegistryCalls::deregisterOperator)
                    }
                    deregisterOperator
                },
                {
                    fn OPERATOR_DOES_NOT_EXIST_ID(
                        ...
                        <OPERATOR_DOES_NOT_EXIST_IDCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IIndexRegistryCalls::OPERATOR_DOES_NOT_EXIST_ID)
                    }
                ...
                },
                {
                    fn currentOperatorIndex(
                        ...
                        <currentOperatorIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IIndexRegistryCalls::currentOperatorIndex)
                    }
                ...
                },
                {
                    fn totalOperatorsForQuorum(
                        ...
                        <totalOperatorsForQuorumCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IIndexRegistryCalls::totalOperatorsForQuorum)
                    }
    ...
    ///Container for all the [`IIndexRegistry`](self) custom errors.
    pub enum IIndexRegistryErrors {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IIndexRegistryErrors {
        const NAME: &'static str = "IIndexRegistryErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IIndexRegistryErrors>] = &[
                {
                    fn OnlyRegistryCoordinator(
                        ...
                        <OnlyRegistryCoordinator as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IIndexRegistryErrors::OnlyRegistryCoordinator)
                    }
                ...
                },
                {
                    fn QuorumDoesNotExist(
                        ...
                        <QuorumDoesNotExist as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IIndexRegistryErrors::QuorumDoesNotExist)
                    }
                    QuorumDoesNotExist
                },
                {
                    fn OperatorIdDoesNotExist(
                        ...
                        <OperatorIdDoesNotExist as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IIndexRegistryErrors::OperatorIdDoesNotExist)
                    }
    ...
    ///Container for all the [`IIndexRegistry`](self) events.
    pub enum IIndexRegistryEvents {
        QuorumIndexUpdate(QuorumIndexUpdate),
    }
    #[automatically_derived]
    impl IIndexRegistryEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IIndexRegistryEvents {
        const NAME: &'static str = "IIndexRegistryEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IIndexRegistryEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IIndexRegistryInstance<T, P, N>>,
    > {
        IIndexRegistryInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IIndexRegistryInstance::<T, P, N>::deploy_builder(provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IIndexRegistryInstance<T, P, N>> {
