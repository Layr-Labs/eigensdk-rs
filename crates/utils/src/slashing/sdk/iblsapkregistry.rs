...
```*/
    ...
    ///Container for all the [`IBLSApkRegistry`](self) function calls.
    pub enum IBLSApkRegistryCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IBLSApkRegistryCalls {
        const NAME: &'static str = "IBLSApkRegistryCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IBLSApkRegistryCalls>] = &[
                {
                    fn operatorToPubkey(
                        data: &[u8],
                        validate: bool,
                        ...
                        <operatorToPubkeyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::operatorToPubkey)
                    }
                    operatorToPubkey
                },
                {
                    fn getOperatorId(
                        ...
                        <getOperatorIdCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::getOperatorId)
                    }
                    getOperatorId
                },
                {
                    fn initializeQuorum(
                        ...
                        <initializeQuorumCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::initializeQuorum)
                    }
                    initializeQuorum
                },
                {
                    fn getApkHistoryLength(
                        ...
                        <getApkHistoryLengthCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::getApkHistoryLength)
                    }
                    getApkHistoryLength
                },
                {
                    fn registerOperator(
                        ...
                        <registerOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::registerOperator)
                    }
                    registerOperator
                },
                {
                    fn getOperatorFromPubkeyHash(
                        ...
                        <getOperatorFromPubkeyHashCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::getOperatorFromPubkeyHash)
                    }
                ...
                },
                {
                    fn getApk(
                        ...
                        <getApkCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::getApk)
                    }
                    getApk
                },
                {
                    fn getApkUpdateAtIndex(
                        ...
                        <getApkUpdateAtIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::getApkUpdateAtIndex)
                    }
                    getApkUpdateAtIndex
                },
                {
                    fn getApkHashAtBlockNumberAndIndex(
                        ...
                        <getApkHashAtBlockNumberAndIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::getApkHashAtBlockNumberAndIndex)
                    }
                ...
                },
                {
                    fn registryCoordinator(
                        ...
                        <registryCoordinatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::registryCoordinator)
                    }
                    registryCoordinator
                },
                {
                    fn apkHistory(
                        ...
                        <apkHistoryCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::apkHistory)
                    }
                    apkHistory
                },
                {
                    fn getRegisteredPubkey(
                        ...
                        <getRegisteredPubkeyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::getRegisteredPubkey)
                    }
                    getRegisteredPubkey
                },
                {
                    fn currentApk(
                        ...
                        <currentApkCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::currentApk)
                    }
                    currentApk
                },
                {
                    fn registerBLSPublicKey(
                        ...
                        <registerBLSPublicKeyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::registerBLSPublicKey)
                    }
                ...
                },
                {
                    fn getApkIndicesAtBlockNumber(
                        ...
                        <getApkIndicesAtBlockNumberCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::getApkIndicesAtBlockNumber)
                    }
                ...
                },
                {
                    fn operatorToPubkeyHash(
                        ...
                        <operatorToPubkeyHashCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::operatorToPubkeyHash)
                    }
                ...
                },
                {
                    fn pubkeyHashToOperator(
                        ...
                        <pubkeyHashToOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::pubkeyHashToOperator)
                    }
                ...
                },
                {
                    fn deregisterOperator(
                        ...
                        <deregisterOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryCalls::deregisterOperator)
                    }
                    deregisterOperator
                },
            ];
    ...
    ///Container for all the [`IBLSApkRegistry`](self) custom errors.
    pub enum IBLSApkRegistryErrors {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IBLSApkRegistryErrors {
        const NAME: &'static str = "IBLSApkRegistryErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IBLSApkRegistryErrors>] = &[
                {
                    fn ZeroPubKey(
                        data: &[u8],
                        validate: bool,
                        ...
                        <ZeroPubKey as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryErrors::ZeroPubKey)
                    }
                    ZeroPubKey
                },
                {
                    fn OperatorNotRegistered(
                        ...
                        <OperatorNotRegistered as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryErrors::OperatorNotRegistered)
                    }
                ...
                },
                {
                    fn BlockNumberTooRecent(
                        ...
                        <BlockNumberTooRecent as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryErrors::BlockNumberTooRecent)
                    }
                ...
                },
                {
                    fn OperatorAlreadyRegistered(
                        ...
                        <OperatorAlreadyRegistered as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryErrors::OperatorAlreadyRegistered)
                    }
                ...
                },
                {
                    fn QuorumAlreadyExists(
                        ...
                        <QuorumAlreadyExists as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryErrors::QuorumAlreadyExists)
                    }
                    QuorumAlreadyExists
                },
                {
                    fn BlockNumberNotLatest(
                        ...
                        <BlockNumberNotLatest as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryErrors::BlockNumberNotLatest)
                    }
                ...
                },
                {
                    fn BLSPubkeyAlreadyRegistered(
                        ...
                        <BLSPubkeyAlreadyRegistered as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryErrors::BLSPubkeyAlreadyRegistered)
                    }
                ...
                },
                {
                    fn InvalidBLSSignatureOrPrivateKey(
                        ...
                        <InvalidBLSSignatureOrPrivateKey as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryErrors::InvalidBLSSignatureOrPrivateKey)
                    }
                ...
                },
                {
                    fn OnlyRegistryCoordinatorOwner(
                        ...
                        <OnlyRegistryCoordinatorOwner as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryErrors::OnlyRegistryCoordinatorOwner)
                    }
                ...
                },
                {
                    fn QuorumDoesNotExist(
                        ...
                        <QuorumDoesNotExist as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IBLSApkRegistryErrors::QuorumDoesNotExist)
                    }
                    QuorumDoesNotExist
                },
            ];
    ...
    ///Container for all the [`IBLSApkRegistry`](self) events.
    pub enum IBLSApkRegistryEvents {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IBLSApkRegistryEvents {
        const NAME: &'static str = "IBLSApkRegistryEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IBLSApkRegistryEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IBLSApkRegistryInstance<T, P, N>>,
    > {
        IBLSApkRegistryInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IBLSApkRegistryInstance::<T, P, N>::deploy_builder(provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IBLSApkRegistryInstance<T, P, N>> {
