...
interface IRegistryCoordinatorEvents {
...
```*/
    ...
    ///Container for all the [`IRegistryCoordinatorEvents`](self) events.
    pub enum IRegistryCoordinatorEventsEvents {
    ...
    #[automatically_derived]
    impl IRegistryCoordinatorEventsEvents {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IRegistryCoordinatorEventsEvents {
        const NAME: &'static str = "IRegistryCoordinatorEventsEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IRegistryCoordinatorEventsEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`IRegistryCoordinatorEvents`](self) contract instance.

See the [wrapper's documentation](`IRegistryCoordinatorEventsInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IRegistryCoordinatorEventsInstance<T, P, N> {
        IRegistryCoordinatorEventsInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IRegistryCoordinatorEventsInstance<T, P, N>>,
    > {
        IRegistryCoordinatorEventsInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IRegistryCoordinatorEventsInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IRegistryCoordinatorEvents`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IRegistryCoordinatorEvents`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IRegistryCoordinatorEventsInstance<
        T,
        P,
        N = alloy_contract::private::Ethereum,
    > {
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IRegistryCoordinatorEventsInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IRegistryCoordinatorEventsInstance")
                .field(&self.address)
                .finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IRegistryCoordinatorEventsInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IRegistryCoordinatorEventsInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(
            self,
        ) -> IRegistryCoordinatorEventsInstance<T, P, N> {
            IRegistryCoordinatorEventsInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
