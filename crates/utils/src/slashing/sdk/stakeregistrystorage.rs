...
interface StakeRegistryStorage {
    ...
    function initializeDelegatedStakeQuorum(uint8 quorumNumber, uint96 minimumStake, IStakeRegistryTypes.StrategyParams[] memory strategyParams) external;
    function initializeSlashableStakeQuorum(uint8 quorumNumber, uint96 minimumStake, uint32 lookAheadPeriod, IStakeRegistryTypes.StrategyParams[] memory strategyParams) external;
    ...
    function registerOperator(address operator, bytes32 operatorId, bytes memory quorumNumbers) external returns (uint96[] memory operatorStakes, uint96[] memory totalStakes);
        ...
        }
        {
            ...
            for UnderlyingRustTuple<'_> {
                fn from(value: registerOperatorReturn) -> Self {
                    (value.operatorStakes, value.totalStakes)
                }
            }
            #[automatically_derived]
            #[doc(hidden)]
        ...
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            for UnderlyingRustTuple<'_> {
                fn from(value: setSlashableStakeLookaheadCall) -> Self {
                    (value.quorumNumber, value.lookAheadBlocks)
                }
            }
            #[automatically_derived]
            #[doc(hidden)]
        ...
        impl alloy_sol_types::SolCall for setSlashableStakeLookaheadCall {
            ...
            fn tokenize(&self) -> Self::Token<'_> {
                (
                    ...
                    <alloy::sol_types::sol_data::Uint<
                        32,
                    > as alloy_sol_types::SolType>::tokenize(&self.lookAheadBlocks),
                )
            }
            #[inline]
            fn abi_decode_returns(
...
```*/
    ...
    ///Container for all the [`StakeRegistryStorage`](self) function calls.
    ...
    #[automatically_derived]
    impl StakeRegistryStorageCalls {
            ...
            ) -> alloy_sol_types::Result<StakeRegistryStorageCalls>] = &[
                {
                    fn getTotalStakeHistoryLength(
                        ...
                        <getTotalStakeHistoryLengthCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::getTotalStakeHistoryLength)
                    }
                ...
                },
                {
                    fn strategyParams(
                        ...
                        <strategyParamsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::strategyParams)
                    }
                    strategyParams
                },
                {
                    fn weightOfOperatorForQuorum(
                        ...
                        <weightOfOperatorForQuorumCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::weightOfOperatorForQuorum)
                    }
                ...
                },
                {
                    fn modifyStrategyParams(
                        ...
                        <modifyStrategyParamsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::modifyStrategyParams)
                    }
                ...
                },
                {
                    fn registerOperator(
                        ...
                        <registerOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::registerOperator)
                    }
                    registerOperator
                },
                {
                    fn getStakeHistory(
                        ...
                        <getStakeHistoryCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::getStakeHistory)
                    }
                    getStakeHistory
                },
                {
                    fn strategyParamsLength(
                        ...
                        <strategyParamsLengthCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::strategyParamsLength)
                    }
                ...
                },
                {
                    fn getStakeHistoryLength(
                        ...
                        <getStakeHistoryLengthCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::getStakeHistoryLength)
                    }
                ...
                },
                {
                    fn getCurrentStake(
                        ...
                        <getCurrentStakeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::getCurrentStake)
                    }
                    getCurrentStake
                },
                {
                    fn WEIGHTING_DIVISOR(
                        ...
                        <WEIGHTING_DIVISORCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::WEIGHTING_DIVISOR)
                    }
                    WEIGHTING_DIVISOR
                },
                {
                    fn removeStrategies(
                        ...
                        <removeStrategiesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::removeStrategies)
                    }
                    removeStrategies
                },
                {
                    fn updateOperatorStake(
                        ...
                        <updateOperatorStakeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::updateOperatorStake)
                    }
                    updateOperatorStake
                },
                {
                ...
                },
                {
                    fn MAX_WEIGHING_FUNCTION_LENGTH(
                        ...
                        <MAX_WEIGHING_FUNCTION_LENGTHCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::MAX_WEIGHING_FUNCTION_LENGTH)
                    }
                ...
                },
                {
                    fn getTotalStakeIndicesAtBlockNumber(
                        ...
                        <getTotalStakeIndicesAtBlockNumberCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                StakeRegistryStorageCalls::getTotalStakeIndicesAtBlockNumber,
                            )
                    }
                ...
                },
                {
                    fn strategiesPerQuorum(
                        ...
                        <strategiesPerQuorumCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::strategiesPerQuorum)
                    }
                    strategiesPerQuorum
                },
                {
                    fn isOperatorSetQuorum(
                        ...
                        <isOperatorSetQuorumCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::isOperatorSetQuorum)
                    }
                    isOperatorSetQuorum
                },
                {
                    fn getStakeUpdateAtIndex(
                        ...
                        <getStakeUpdateAtIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::getStakeUpdateAtIndex)
                    }
                ...
                },
                {
                    fn strategyParamsByIndex(
                        ...
                        <strategyParamsByIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::strategyParamsByIndex)
                    }
                ...
                },
                {
                    fn getTotalStakeUpdateAtIndex(
                        ...
                        <getTotalStakeUpdateAtIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::getTotalStakeUpdateAtIndex)
                    }
                ...
                },
                {
                    fn setMinimumStakeForQuorum(
                        ...
                        <setMinimumStakeForQuorumCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::setMinimumStakeForQuorum)
                    }
                ...
                },
                {
                    fn deregisterOperator(
                        ...
                        <deregisterOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::deregisterOperator)
                    }
                    deregisterOperator
                },
                {
                    fn minimumStakeForQuorum(
                        ...
                        <minimumStakeForQuorumCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::minimumStakeForQuorum)
                    }
                ...
                },
                {
                    fn addStrategies(
                        ...
                        <addStrategiesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::addStrategies)
                    }
                    addStrategies
                },
                {
                    fn getTotalStakeAtBlockNumberFromIndex(
                        ...
                        <getTotalStakeAtBlockNumberFromIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                StakeRegistryStorageCalls::getTotalStakeAtBlockNumberFromIndex,
                            )
                    }
                ...
                },
                {
                    fn allocationManager(
                        ...
                        <allocationManagerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::allocationManager)
                    }
                    allocationManager
                },
                {
                ...
                },
                {
                    fn getCurrentTotalStake(
                        ...
                        <getCurrentTotalStakeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::getCurrentTotalStake)
                    }
                ...
                },
                {
                    fn getStakeUpdateIndexAtBlockNumber(
                        ...
                        <getStakeUpdateIndexAtBlockNumberCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                StakeRegistryStorageCalls::getStakeUpdateIndexAtBlockNumber,
                            )
                    }
                ...
                },
                {
                    fn delegation(
                        ...
                        <delegationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::delegation)
                    }
                    delegation
                },
                {
                    fn setSlashableStakeLookahead(
                        ...
                        <setSlashableStakeLookaheadCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::setSlashableStakeLookahead)
                    }
                ...
                },
                {
                    fn getStakeAtBlockNumberAndIndex(
                        ...
                        <getStakeAtBlockNumberAndIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                StakeRegistryStorageCalls::getStakeAtBlockNumberAndIndex,
                            )
                    }
                ...
                },
                {
                    fn getLatestStakeUpdate(
                        ...
                        <getLatestStakeUpdateCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::getLatestStakeUpdate)
                    }
                ...
                },
                {
                    fn getStakeAtBlockNumber(
                        ...
                        <getStakeAtBlockNumberCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageCalls::getStakeAtBlockNumber)
                    }
    ...
    ///Container for all the [`StakeRegistryStorage`](self) custom errors.
    pub enum StakeRegistryStorageErrors {
    ...
    #[automatically_derived]
    impl StakeRegistryStorageErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for StakeRegistryStorageErrors {
        const NAME: &'static str = "StakeRegistryStorageErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<StakeRegistryStorageErrors>] = &[
                {
                    fn BelowMinimumStakeRequirement(
                        ...
                        <BelowMinimumStakeRequirement as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                StakeRegistryStorageErrors::BelowMinimumStakeRequirement,
                            )
                    }
                ...
                },
                {
                    fn QuorumAlreadyExists(
                        ...
                        <QuorumAlreadyExists as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageErrors::QuorumAlreadyExists)
                    }
                    QuorumAlreadyExists
                },
                {
                    fn InputArrayLengthMismatch(
                        ...
                        <InputArrayLengthMismatch as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageErrors::InputArrayLengthMismatch)
                    }
                ...
                },
                {
                    fn InvalidBlockNumber(
                        ...
                        <InvalidBlockNumber as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageErrors::InvalidBlockNumber)
                    }
                    InvalidBlockNumber
                },
                {
                    fn InputMultiplierZero(
                        ...
                        <InputMultiplierZero as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageErrors::InputMultiplierZero)
                    }
                    InputMultiplierZero
                },
                {
                    fn InputArrayLengthZero(
                        ...
                        <InputArrayLengthZero as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageErrors::InputArrayLengthZero)
                    }
                ...
                },
                {
                    fn InputDuplicateStrategy(
                        ...
                        <InputDuplicateStrategy as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageErrors::InputDuplicateStrategy)
                    }
                ...
                },
                {
                    fn OnlySlashingRegistryCoordinator(
                        ...
                        <OnlySlashingRegistryCoordinator as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                StakeRegistryStorageErrors::OnlySlashingRegistryCoordinator,
                            )
                    }
                ...
                },
                {
                    fn EmptyStakeHistory(
                        ...
                        <EmptyStakeHistory as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageErrors::EmptyStakeHistory)
                    }
                    EmptyStakeHistory
                },
                {
                    fn OnlySlashingRegistryCoordinatorOwner(
                        ...
                        <OnlySlashingRegistryCoordinatorOwner as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                StakeRegistryStorageErrors::OnlySlashingRegistryCoordinatorOwner,
                            )
                    }
                ...
                },
                {
                    fn QuorumDoesNotExist(
                        ...
                        <QuorumDoesNotExist as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(StakeRegistryStorageErrors::QuorumDoesNotExist)
                    }
                    QuorumDoesNotExist
                },
            ];
    ...
    #[automatically_derived]
    impl StakeRegistryStorageEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`StakeRegistryStorage`](self) contract instance.

See the [wrapper's documentation](`StakeRegistryStorageInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> StakeRegistryStorageInstance<T, P, N> {
        StakeRegistryStorageInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<StakeRegistryStorageInstance<T, P, N>>,
    > {
        StakeRegistryStorageInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        StakeRegistryStorageInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`StakeRegistryStorage`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`StakeRegistryStorage`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct StakeRegistryStorageInstance<
        T,
        P,
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for StakeRegistryStorageInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("StakeRegistryStorageInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    #[automatically_derived]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<StakeRegistryStorageInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> StakeRegistryStorageInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> StakeRegistryStorageInstance<T, P, N> {
            StakeRegistryStorageInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
