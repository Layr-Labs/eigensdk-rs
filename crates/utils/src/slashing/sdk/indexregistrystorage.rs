...
interface IndexRegistryStorage {
...
```*/
    ...
    ///Container for all the [`IndexRegistryStorage`](self) function calls.
    ...
    #[automatically_derived]
    impl IndexRegistryStorageCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IndexRegistryStorageCalls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IndexRegistryStorageCalls>] = &[
                {
                    fn registerOperator(
                        data: &[u8],
                        validate: bool,
                        ...
                        <registerOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IndexRegistryStorageCalls::registerOperator)
                    }
                    registerOperator
                },
                {
                    fn getLatestOperatorUpdate(
                        ...
                        <getLatestOperatorUpdateCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IndexRegistryStorageCalls::getLatestOperatorUpdate)
                    }
                ...
                },
                {
                    fn initializeQuorum(
                        ...
                        <initializeQuorumCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IndexRegistryStorageCalls::initializeQuorum)
                    }
                    initializeQuorum
                },
                {
                    fn getOperatorUpdateAtIndex(
                        ...
                        <getOperatorUpdateAtIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IndexRegistryStorageCalls::getOperatorUpdateAtIndex)
                    }
                ...
                },
                {
                    fn registryCoordinator(
                        ...
                        <registryCoordinatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IndexRegistryStorageCalls::registryCoordinator)
                    }
                    registryCoordinator
                },
                {
                    fn getLatestQuorumUpdate(
                        ...
                        <getLatestQuorumUpdateCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IndexRegistryStorageCalls::getLatestQuorumUpdate)
                    }
                ...
                },
                {
                    fn getOperatorListAtBlockNumber(
                        ...
                        <getOperatorListAtBlockNumberCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IndexRegistryStorageCalls::getOperatorListAtBlockNumber)
                    }
                ...
                },
                {
                    fn getQuorumUpdateAtIndex(
                        ...
                        <getQuorumUpdateAtIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IndexRegistryStorageCalls::getQuorumUpdateAtIndex)
                    }
                ...
                },
                {
                    fn deregisterOperator(
                        ...
                        <deregisterOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IndexRegistryStorageCalls::deregisterOperator)
                    }
                    deregisterOperator
                },
                {
                    fn OPERATOR_DOES_NOT_EXIST_ID(
                        ...
                        <OPERATOR_DOES_NOT_EXIST_IDCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IndexRegistryStorageCalls::OPERATOR_DOES_NOT_EXIST_ID)
                    }
                ...
                },
                {
                    fn currentOperatorIndex(
                        ...
                        <currentOperatorIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IndexRegistryStorageCalls::currentOperatorIndex)
                    }
                ...
                },
                {
                    fn totalOperatorsForQuorum(
                        ...
                        <totalOperatorsForQuorumCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IndexRegistryStorageCalls::totalOperatorsForQuorum)
                    }
    ...
    ///Container for all the [`IndexRegistryStorage`](self) custom errors.
    pub enum IndexRegistryStorageErrors {
    ...
    #[automatically_derived]
    impl IndexRegistryStorageErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IndexRegistryStorageErrors {
        const NAME: &'static str = "IndexRegistryStorageErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IndexRegistryStorageErrors>] = &[
                {
                    fn OnlyRegistryCoordinator(
                        ...
                        <OnlyRegistryCoordinator as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IndexRegistryStorageErrors::OnlyRegistryCoordinator)
                    }
                ...
                },
                {
                    fn QuorumDoesNotExist(
                        ...
                        <QuorumDoesNotExist as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IndexRegistryStorageErrors::QuorumDoesNotExist)
                    }
                    QuorumDoesNotExist
                },
                {
                    fn OperatorIdDoesNotExist(
                        ...
                        <OperatorIdDoesNotExist as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IndexRegistryStorageErrors::OperatorIdDoesNotExist)
                    }
    ...
    ///Container for all the [`IndexRegistryStorage`](self) events.
    pub enum IndexRegistryStorageEvents {
        Initialized(Initialized),
        QuorumIndexUpdate(QuorumIndexUpdate),
    }
    #[automatically_derived]
    impl IndexRegistryStorageEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IndexRegistryStorageEvents {
        const NAME: &'static str = "IndexRegistryStorageEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IndexRegistryStorageEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`IndexRegistryStorage`](self) contract instance.

See the [wrapper's documentation](`IndexRegistryStorageInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IndexRegistryStorageInstance<T, P, N> {
        IndexRegistryStorageInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IndexRegistryStorageInstance<T, P, N>>,
    > {
        IndexRegistryStorageInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IndexRegistryStorageInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IndexRegistryStorage`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IndexRegistryStorage`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IndexRegistryStorageInstance<
        T,
        P,
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IndexRegistryStorageInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IndexRegistryStorageInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    #[automatically_derived]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IndexRegistryStorageInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IndexRegistryStorageInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IndexRegistryStorageInstance<T, P, N> {
            IndexRegistryStorageInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
