...
interface SlashingRegistryCoordinatorStorage {
...
```*/
    ...
    ///Container for all the [`SlashingRegistryCoordinatorStorage`](self) function calls.
    pub enum SlashingRegistryCoordinatorStorageCalls {
    ...
    #[automatically_derived]
    impl SlashingRegistryCoordinatorStorageCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for SlashingRegistryCoordinatorStorageCalls {
        const NAME: &'static str = "SlashingRegistryCoordinatorStorageCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<SlashingRegistryCoordinatorStorageCalls>] = &[
                {
                    fn updateOperators(
                        data: &[u8],
                        validate: bool,
                    ) -> alloy_sol_types::Result<
                        SlashingRegistryCoordinatorStorageCalls,
                    > {
                        <updateOperatorsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::updateOperators,
                            )
                    }
                    updateOperators
                },
                {
                    ...
                    > {
                        <getQuorumBitmapHistoryLengthCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::getQuorumBitmapHistoryLength,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <getQuorumBitmapAtBlockNumberByIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::getQuorumBitmapAtBlockNumberByIndex,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <churnApproverCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageCalls::churnApprover)
                    }
                    churnApprover
                },
                {
                    ...
                    > {
                        <accountIdentifierCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::accountIdentifier,
                            )
                    }
                    accountIdentifier
                },
                {
                    ...
                    > {
                        <updateSocketCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageCalls::updateSocket)
                    }
                    updateSocket
                },
                {
                    ...
                    > {
                        <setEjectionCooldownCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::setEjectionCooldown,
                            )
                    }
                    setEjectionCooldown
                },
                {
                    ...
                    > {
                        <lastEjectionTimestampCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::lastEjectionTimestamp,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <getOperatorIdCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageCalls::getOperatorId)
                    }
                    getOperatorId
                },
                {
                    ...
                    > {
                        <isChurnApproverSaltUsedCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::isChurnApproverSaltUsed,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <getQuorumBitmapUpdateByIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::getQuorumBitmapUpdateByIndex,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <quorumUpdateBlockNumberCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::quorumUpdateBlockNumber,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <ejectorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageCalls::ejector)
                    }
                    ejector
                },
                {
                    ...
                    > {
                        <getOperatorFromIdCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::getOperatorFromId,
                            )
                    }
                    getOperatorFromId
                },
                {
                    ...
                    > {
                        <setChurnApproverCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::setChurnApprover,
                            )
                    }
                    setChurnApprover
                },
                {
                    ...
                    > {
                        <setEjectorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageCalls::setEjector)
                    }
                    setEjector
                },
                {
                    ...
                    > {
                        <pubkeyRegistrationMessageHashCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::pubkeyRegistrationMessageHash,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <createSlashableStakeQuorumCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::createSlashableStakeQuorum,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <updateOperatorsForQuorumCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::updateOperatorsForQuorum,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <getOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageCalls::getOperator)
                    }
                    getOperator
                },
                {
                    ...
                    > {
                        <setOperatorSetParamsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::setOperatorSetParams,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <blsApkRegistryCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageCalls::blsApkRegistry)
                    }
                    blsApkRegistry
                },
                {
                    ...
                    > {
                        <registriesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageCalls::registries)
                    }
                    registries
                },
                {
                    ...
                    > {
                        <stakeRegistryCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageCalls::stakeRegistry)
                    }
                    stakeRegistry
                },
                {
                    ...
                    > {
                        <ejectOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageCalls::ejectOperator)
                    }
                    ejectOperator
                },
                {
                    ...
                    > {
                        <operatorSetsEnabledCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::operatorSetsEnabled,
                            )
                    }
                    operatorSetsEnabled
                },
                {
                    ...
                    > {
                        <createTotalDelegatedStakeQuorumCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::createTotalDelegatedStakeQuorum,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <calculateOperatorChurnApprovalDigestHashCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::calculateOperatorChurnApprovalDigestHash,
                            )
                    }
                    calculateOperatorChurnApprovalDigestHash
                },
                {
                    ...
                    > {
                        <getCurrentQuorumBitmapCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::getCurrentQuorumBitmap,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <ownerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageCalls::owner)
                    }
                    owner
                },
                {
                    ...
                    > {
                        <quorumCountCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageCalls::quorumCount)
                    }
                    quorumCount
                },
                {
                    ...
                    > {
                        <deregisterOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::deregisterOperator,
                            )
                    }
                    deregisterOperator
                },
                {
                    ...
                    > {
                        <indexRegistryCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageCalls::indexRegistry)
                    }
                    indexRegistry
                },
                {
                    ...
                    > {
                        <PUBKEY_REGISTRATION_TYPEHASHCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::PUBKEY_REGISTRATION_TYPEHASH,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <isM2QuorumCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageCalls::isM2Quorum)
                    }
                    isM2Quorum
                },
                {
                    ...
                    > {
                        <ejectionCooldownCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::ejectionCooldown,
                            )
                    }
                    ejectionCooldown
                },
                {
                    ...
                    > {
                        <registerOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::registerOperator,
                            )
                    }
                    registerOperator
                },
                {
                    ...
                    > {
                        <m2QuorumsDisabledCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::m2QuorumsDisabled,
                            )
                    }
                    m2QuorumsDisabled
                },
                {
                    ...
                    > {
                        <getQuorumBitmapIndicesAtBlockNumberCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::getQuorumBitmapIndicesAtBlockNumber,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <OPERATOR_CHURN_APPROVAL_TYPEHASHCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::OPERATOR_CHURN_APPROVAL_TYPEHASH,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <allocationManagerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::allocationManager,
                            )
                    }
                    allocationManager
                },
                {
                    ...
                    > {
                        <numRegistriesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageCalls::numRegistries)
                    }
                    numRegistries
                },
                {
                    ...
                    > {
                        <getOperatorSetParamsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::getOperatorSetParams,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <socketRegistryCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageCalls::socketRegistry)
                    }
                    socketRegistry
                },
                {
                    ...
                    > {
                        <getOperatorStatusCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageCalls::getOperatorStatus,
                            )
                    }
                    getOperatorStatus
                },
    ...
    ///Container for all the [`SlashingRegistryCoordinatorStorage`](self) custom errors.
    pub enum SlashingRegistryCoordinatorStorageErrors {
    ...
    #[automatically_derived]
    impl SlashingRegistryCoordinatorStorageErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for SlashingRegistryCoordinatorStorageErrors {
        const NAME: &'static str = "SlashingRegistryCoordinatorStorageErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<SlashingRegistryCoordinatorStorageErrors>] = &[
                {
                    fn AlreadyRegisteredForQuorums(
                        data: &[u8],
                        validate: bool,
                    ) -> alloy_sol_types::Result<
                        SlashingRegistryCoordinatorStorageErrors,
                    > {
                        <AlreadyRegisteredForQuorums as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageErrors::AlreadyRegisteredForQuorums,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <BitmapEmpty as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageErrors::BitmapEmpty)
                    }
                    BitmapEmpty
                },
                {
                    ...
                    > {
                        <OnlyAllocationManager as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageErrors::OnlyAllocationManager,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <CannotReregisterYet as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageErrors::CannotReregisterYet,
                            )
                    }
                    CannotReregisterYet
                },
                {
                    ...
                    > {
                        <InvalidRegistrationType as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageErrors::InvalidRegistrationType,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <MaxQuorumsReached as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageErrors::MaxQuorumsReached,
                            )
                    }
                    MaxQuorumsReached
                },
                {
                    ...
                    > {
                        <InsufficientStakeForChurn as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageErrors::InsufficientStakeForChurn,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <OperatorSetsNotEnabled as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageErrors::OperatorSetsNotEnabled,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <QuorumOperatorCountMismatch as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageErrors::QuorumOperatorCountMismatch,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <InputLengthMismatch as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageErrors::InputLengthMismatch,
                            )
                    }
                    InputLengthMismatch
                },
                {
                    ...
                    > {
                        <NotRegistered as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageErrors::NotRegistered)
                    }
                    NotRegistered
                },
                {
                    ...
                    > {
                        <CannotChurnSelf as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageErrors::CannotChurnSelf,
                            )
                    }
                    CannotChurnSelf
                },
                {
                    ...
                    > {
                        <CannotKickOperatorAboveThreshold as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageErrors::CannotKickOperatorAboveThreshold,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <NotSorted as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageErrors::NotSorted)
                    }
                    NotSorted
                },
                {
                    ...
                    > {
                        <NotRegisteredForQuorum as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageErrors::NotRegisteredForQuorum,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <BitmapCannotBeZero as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageErrors::BitmapCannotBeZero,
                            )
                    }
                    BitmapCannotBeZero
                },
                {
                    ...
                    > {
                        <ChurnApproverSaltUsed as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageErrors::ChurnApproverSaltUsed,
                            )
                    }
                ...
                },
                {
                    ...
                    > {
                        <QuorumDoesNotExist as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                SlashingRegistryCoordinatorStorageErrors::QuorumDoesNotExist,
                            )
                    }
                    QuorumDoesNotExist
                },
                {
                    ...
                    > {
                        <OnlyEjector as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(SlashingRegistryCoordinatorStorageErrors::OnlyEjector)
                    }
                    OnlyEjector
                },
            ];
    ...
    ///Container for all the [`SlashingRegistryCoordinatorStorage`](self) events.
    pub enum SlashingRegistryCoordinatorStorageEvents {
    ...
    #[automatically_derived]
    impl SlashingRegistryCoordinatorStorageEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    for SlashingRegistryCoordinatorStorageEvents {
        const NAME: &'static str = "SlashingRegistryCoordinatorStorageEvents";
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`SlashingRegistryCoordinatorStorage`](self) contract instance.

See the [wrapper's documentation](`SlashingRegistryCoordinatorStorageInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> SlashingRegistryCoordinatorStorageInstance<T, P, N> {
        SlashingRegistryCoordinatorStorageInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        >,
    > {
        SlashingRegistryCoordinatorStorageInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        SlashingRegistryCoordinatorStorageInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`SlashingRegistryCoordinatorStorage`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`SlashingRegistryCoordinatorStorage`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct SlashingRegistryCoordinatorStorageInstance<
        T,
        P,
        N = alloy_contract::private::Ethereum,
    > {
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug
    for SlashingRegistryCoordinatorStorageInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("SlashingRegistryCoordinatorStorageInstance")
                .field(&self.address)
                .finish()
        }
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    > SlashingRegistryCoordinatorStorageInstance<T, &P, N> {
        ...
        pub fn with_cloned_provider(
            ...
            SlashingRegistryCoordinatorStorageInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
