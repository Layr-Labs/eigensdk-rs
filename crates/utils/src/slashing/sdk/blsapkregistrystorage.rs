...
interface BLSApkRegistryStorage {
...
```*/
    ...
    ///Container for all the [`BLSApkRegistryStorage`](self) function calls.
    ...
    #[automatically_derived]
    impl BLSApkRegistryStorageCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for BLSApkRegistryStorageCalls {
        const NAME: &'static str = "BLSApkRegistryStorageCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<BLSApkRegistryStorageCalls>] = &[
                {
                    fn operatorToPubkey(
                        data: &[u8],
                        validate: bool,
                        ...
                        <operatorToPubkeyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageCalls::operatorToPubkey)
                    }
                    operatorToPubkey
                },
                {
                    fn getOperatorId(
                        ...
                        <getOperatorIdCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageCalls::getOperatorId)
                    }
                    getOperatorId
                },
                {
                    fn initializeQuorum(
                        ...
                        <initializeQuorumCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageCalls::initializeQuorum)
                    }
                    initializeQuorum
                },
                {
                    fn getApkHistoryLength(
                        ...
                        <getApkHistoryLengthCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageCalls::getApkHistoryLength)
                    }
                    getApkHistoryLength
                },
                {
                    fn registerOperator(
                        ...
                        <registerOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageCalls::registerOperator)
                    }
                    registerOperator
                },
                {
                    fn getOperatorFromPubkeyHash(
                        ...
                        <getOperatorFromPubkeyHashCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageCalls::getOperatorFromPubkeyHash)
                    }
                ...
                },
                {
                    fn getApk(
                        ...
                        <getApkCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageCalls::getApk)
                    }
                    getApk
                },
                {
                    fn getApkUpdateAtIndex(
                        ...
                        <getApkUpdateAtIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageCalls::getApkUpdateAtIndex)
                    }
                    getApkUpdateAtIndex
                },
                {
                    fn getApkHashAtBlockNumberAndIndex(
                        ...
                        <getApkHashAtBlockNumberAndIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                BLSApkRegistryStorageCalls::getApkHashAtBlockNumberAndIndex,
                            )
                    }
                ...
                },
                {
                    fn registryCoordinator(
                        ...
                        <registryCoordinatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageCalls::registryCoordinator)
                    }
                    registryCoordinator
                },
                {
                    fn apkHistory(
                        ...
                        <apkHistoryCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageCalls::apkHistory)
                    }
                    apkHistory
                },
                {
                    fn getRegisteredPubkey(
                        ...
                        <getRegisteredPubkeyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageCalls::getRegisteredPubkey)
                    }
                    getRegisteredPubkey
                },
                {
                    fn currentApk(
                        ...
                        <currentApkCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageCalls::currentApk)
                    }
                    currentApk
                },
                {
                    fn registerBLSPublicKey(
                        ...
                        <registerBLSPublicKeyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageCalls::registerBLSPublicKey)
                    }
                ...
                },
                {
                    fn getApkIndicesAtBlockNumber(
                        ...
                        <getApkIndicesAtBlockNumberCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageCalls::getApkIndicesAtBlockNumber)
                    }
                ...
                },
                {
                    fn operatorToPubkeyHash(
                        ...
                        <operatorToPubkeyHashCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageCalls::operatorToPubkeyHash)
                    }
                ...
                },
                {
                    fn pubkeyHashToOperator(
                        ...
                        <pubkeyHashToOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageCalls::pubkeyHashToOperator)
                    }
                ...
                },
                {
                    fn deregisterOperator(
                        ...
                        <deregisterOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageCalls::deregisterOperator)
                    }
                    deregisterOperator
                },
            ];
    ...
    ///Container for all the [`BLSApkRegistryStorage`](self) custom errors.
    pub enum BLSApkRegistryStorageErrors {
    ...
    #[automatically_derived]
    impl BLSApkRegistryStorageErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for BLSApkRegistryStorageErrors {
        const NAME: &'static str = "BLSApkRegistryStorageErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<BLSApkRegistryStorageErrors>] = &[
                {
                    fn ZeroPubKey(
                        data: &[u8],
                        validate: bool,
                        ...
                        <ZeroPubKey as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageErrors::ZeroPubKey)
                    }
                    ZeroPubKey
                },
                {
                    fn OperatorNotRegistered(
                        ...
                        <OperatorNotRegistered as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageErrors::OperatorNotRegistered)
                    }
                ...
                },
                {
                    fn BlockNumberTooRecent(
                        ...
                        <BlockNumberTooRecent as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageErrors::BlockNumberTooRecent)
                    }
                ...
                },
                {
                    fn OperatorAlreadyRegistered(
                        ...
                        <OperatorAlreadyRegistered as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageErrors::OperatorAlreadyRegistered)
                    }
                ...
                },
                {
                    fn QuorumAlreadyExists(
                        ...
                        <QuorumAlreadyExists as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageErrors::QuorumAlreadyExists)
                    }
                    QuorumAlreadyExists
                },
                {
                    fn BlockNumberNotLatest(
                        ...
                        <BlockNumberNotLatest as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageErrors::BlockNumberNotLatest)
                    }
                ...
                },
                {
                    fn BLSPubkeyAlreadyRegistered(
                        ...
                        <BLSPubkeyAlreadyRegistered as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageErrors::BLSPubkeyAlreadyRegistered)
                    }
                ...
                },
                {
                    fn InvalidBLSSignatureOrPrivateKey(
                        ...
                        <InvalidBLSSignatureOrPrivateKey as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                BLSApkRegistryStorageErrors::InvalidBLSSignatureOrPrivateKey,
                            )
                    }
                ...
                },
                {
                    fn OnlyRegistryCoordinatorOwner(
                        ...
                        <OnlyRegistryCoordinatorOwner as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                BLSApkRegistryStorageErrors::OnlyRegistryCoordinatorOwner,
                            )
                    }
                ...
                },
                {
                    fn QuorumDoesNotExist(
                        ...
                        <QuorumDoesNotExist as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BLSApkRegistryStorageErrors::QuorumDoesNotExist)
                    }
                    QuorumDoesNotExist
                },
            ];
    ...
    ///Container for all the [`BLSApkRegistryStorage`](self) events.
    ...
    #[automatically_derived]
    impl BLSApkRegistryStorageEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for BLSApkRegistryStorageEvents {
        const NAME: &'static str = "BLSApkRegistryStorageEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for BLSApkRegistryStorageEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`BLSApkRegistryStorage`](self) contract instance.

See the [wrapper's documentation](`BLSApkRegistryStorageInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> BLSApkRegistryStorageInstance<T, P, N> {
        BLSApkRegistryStorageInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<BLSApkRegistryStorageInstance<T, P, N>>,
    > {
        BLSApkRegistryStorageInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        BLSApkRegistryStorageInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`BLSApkRegistryStorage`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`BLSApkRegistryStorage`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct BLSApkRegistryStorageInstance<
        T,
        P,
        N = alloy_contract::private::Ethereum,
    > {
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for BLSApkRegistryStorageInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("BLSApkRegistryStorageInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    #[automatically_derived]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<BLSApkRegistryStorageInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> BLSApkRegistryStorageInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> BLSApkRegistryStorageInstance<T, P, N> {
            BLSApkRegistryStorageInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
