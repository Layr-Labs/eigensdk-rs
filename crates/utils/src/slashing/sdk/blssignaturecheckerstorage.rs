...
interface BLSSignatureCheckerStorage {
...
```*/
    ...
    ///Container for all the [`BLSSignatureCheckerStorage`](self) function calls.
    pub enum BLSSignatureCheckerStorageCalls {
    ...
    #[automatically_derived]
    impl BLSSignatureCheckerStorageCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for BLSSignatureCheckerStorageCalls {
        const NAME: &'static str = "BLSSignatureCheckerStorageCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<BLSSignatureCheckerStorageCalls>] = &[
                {
                    fn trySignatureAndApkVerification(
                        ...
                        <trySignatureAndApkVerificationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                BLSSignatureCheckerStorageCalls::trySignatureAndApkVerification,
                            )
                    }
                ...
                },
                {
                    fn setStaleStakesForbidden(
                        ...
                        <setStaleStakesForbiddenCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                BLSSignatureCheckerStorageCalls::setStaleStakesForbidden,
                            )
                    }
                ...
                },
                {
                    fn blsApkRegistry(
                        ...
                        <blsApkRegistryCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSSignatureCheckerStorageCalls::blsApkRegistry)
                    }
                    blsApkRegistry
                },
                {
                    fn stakeRegistry(
                        ...
                        <stakeRegistryCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSSignatureCheckerStorageCalls::stakeRegistry)
                    }
                    stakeRegistry
                },
                {
                    fn registryCoordinator(
                        ...
                        <registryCoordinatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSSignatureCheckerStorageCalls::registryCoordinator)
                    }
                    registryCoordinator
                },
                {
                    fn checkSignatures(
                        ...
                        <checkSignaturesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSSignatureCheckerStorageCalls::checkSignatures)
                    }
                    checkSignatures
                },
                {
                    fn staleStakesForbidden(
                        ...
                        <staleStakesForbiddenCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSSignatureCheckerStorageCalls::staleStakesForbidden)
                    }
                ...
                },
                {
                    fn delegation(
                        ...
                        <delegationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BLSSignatureCheckerStorageCalls::delegation)
                    }
                    delegation
                },
            ];
    ...
    ///Container for all the [`BLSSignatureCheckerStorage`](self) custom errors.
    pub enum BLSSignatureCheckerStorageErrors {
    ...
    #[automatically_derived]
    impl BLSSignatureCheckerStorageErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for BLSSignatureCheckerStorageErrors {
        const NAME: &'static str = "BLSSignatureCheckerStorageErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<BLSSignatureCheckerStorageErrors>] = &[
                {
                    fn InputEmptyQuorumNumbers(
                        ...
                        <InputEmptyQuorumNumbers as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                BLSSignatureCheckerStorageErrors::InputEmptyQuorumNumbers,
                            )
                    }
                ...
                },
                {
                    fn InputArrayLengthMismatch(
                        ...
                        <InputArrayLengthMismatch as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                BLSSignatureCheckerStorageErrors::InputArrayLengthMismatch,
                            )
                    }
                ...
                },
                {
                    fn InvalidReferenceBlocknumber(
                        ...
                        <InvalidReferenceBlocknumber as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                BLSSignatureCheckerStorageErrors::InvalidReferenceBlocknumber,
                            )
                    }
                ...
                },
                {
                    fn InputNonSignerLengthMismatch(
                        ...
                        <InputNonSignerLengthMismatch as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                BLSSignatureCheckerStorageErrors::InputNonSignerLengthMismatch,
                            )
                    }
                ...
                },
                {
                    fn InvalidBLSPairingKey(
                        ...
                        <InvalidBLSPairingKey as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BLSSignatureCheckerStorageErrors::InvalidBLSPairingKey)
                    }
                ...
                },
                {
                    fn InvalidBLSSignature(
                        ...
                        <InvalidBLSSignature as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BLSSignatureCheckerStorageErrors::InvalidBLSSignature)
                    }
                    InvalidBLSSignature
                },
                {
                    fn StaleStakesForbidden(
                        ...
                        <StaleStakesForbidden as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BLSSignatureCheckerStorageErrors::StaleStakesForbidden)
                    }
                    StaleStakesForbidden
                },
                {
                    fn OnlyRegistryCoordinatorOwner(
                        ...
                        <OnlyRegistryCoordinatorOwner as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                BLSSignatureCheckerStorageErrors::OnlyRegistryCoordinatorOwner,
                            )
                    }
                ...
                },
                {
                    fn InvalidQuorumApkHash(
                        ...
                        <InvalidQuorumApkHash as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BLSSignatureCheckerStorageErrors::InvalidQuorumApkHash)
                    }
                ...
                },
                {
                    fn NonSignerPubkeysNotSorted(
                        ...
                        <NonSignerPubkeysNotSorted as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                BLSSignatureCheckerStorageErrors::NonSignerPubkeysNotSorted,
                            )
                    }
    ...
    ///Container for all the [`BLSSignatureCheckerStorage`](self) events.
    pub enum BLSSignatureCheckerStorageEvents {
        StaleStakesForbiddenUpdate(StaleStakesForbiddenUpdate),
    }
    #[automatically_derived]
    impl BLSSignatureCheckerStorageEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for BLSSignatureCheckerStorageEvents {
        const NAME: &'static str = "BLSSignatureCheckerStorageEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for BLSSignatureCheckerStorageEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`BLSSignatureCheckerStorage`](self) contract instance.

See the [wrapper's documentation](`BLSSignatureCheckerStorageInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> BLSSignatureCheckerStorageInstance<T, P, N> {
        BLSSignatureCheckerStorageInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<BLSSignatureCheckerStorageInstance<T, P, N>>,
    > {
        BLSSignatureCheckerStorageInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        BLSSignatureCheckerStorageInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`BLSSignatureCheckerStorage`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`BLSSignatureCheckerStorage`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct BLSSignatureCheckerStorageInstance<
        T,
        P,
        N = alloy_contract::private::Ethereum,
    > {
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for BLSSignatureCheckerStorageInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("BLSSignatureCheckerStorageInstance")
                .field(&self.address)
                .finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<BLSSignatureCheckerStorageInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> BLSSignatureCheckerStorageInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(
            self,
        ) -> BLSSignatureCheckerStorageInstance<T, P, N> {
            BLSSignatureCheckerStorageInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
