...
pub mod ServiceManagerBase {
    ...
    impl alloy_sol_types::SolInterface for ServiceManagerBaseCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<ServiceManagerBaseCalls>] = &[
                {
                    fn removeAdmin(
                        ...
                        <removeAdminCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ServiceManagerBaseCalls::removeAdmin)
                    }
                    removeAdmin
                },
                {
                    fn setAppointee(
                        ...
                        <setAppointeeCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ServiceManagerBaseCalls::setAppointee)
                    }
                    setAppointee
                },
                {
                    fn addPendingAdmin(
                        ...
                        <addPendingAdminCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ServiceManagerBaseCalls::addPendingAdmin)
                    }
                    addPendingAdmin
                },
                {
                ...
                {
                    fn owner(data: &[u8]) -> alloy_sol_types::Result<ServiceManagerBaseCalls> {
                ...
                },
                {
                    fn removePendingAdmin(
                        ...
                        <removePendingAdminCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ServiceManagerBaseCalls::removePendingAdmin)
                    }
                    removePendingAdmin
                },
                {
                ...
                },
                {
                    fn removeAppointee(
                        ...
                        <removeAppointeeCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ServiceManagerBaseCalls::removeAppointee)
                    }
                    removeAppointee
                },
                {
                ...
                },
                {
                    fn OnlyRegistryCoordinator(
                        ...
                        <OnlyRegistryCoordinator as alloy_sol_types::SolError>::abi_decode_raw(data)
                            .map(ServiceManagerBaseErrors::OnlyRegistryCoordinator)
                    }
                ...
                },
                {
                    fn OnlyRewardsInitiator(
                        ...
                        <OnlyRewardsInitiator as alloy_sol_types::SolError>::abi_decode_raw(data)
                            .map(ServiceManagerBaseErrors::OnlyRewardsInitiator)
                    }
                ...
                },
                {
                    fn DelayPeriodNotPassed(
                        ...
                        <DelayPeriodNotPassed as alloy_sol_types::SolError>::abi_decode_raw(data)
                            .map(ServiceManagerBaseErrors::DelayPeriodNotPassed)
                    }
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> ServiceManagerBaseInstance<P, N> {
        ServiceManagerBaseInstance::<P, N>::new(address, provider)
    }
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<ServiceManagerBaseInstance<P, N>>>
    {
        ServiceManagerBaseInstance::<P, N>::deploy(provider)
    }
    ...
    >(
        ...
        ServiceManagerBaseInstance::<P, N>::deploy_builder(provider)
    }
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ServiceManagerBaseInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ServiceManagerBaseInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        ...
        ServiceManagerBaseInstance<P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ServiceManagerBaseInstance<P, N>> {
    ...
    impl<P: ::core::clone::Clone, N> ServiceManagerBaseInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ServiceManagerBaseInstance<P, N> {
