...
pub mod IRewardsCoordinator {
    ...
    const _: () = {
        ...
        impl createRewardsForAllEarnersReturn {
            fn _tokenize(
                &self,
            ) -> <createRewardsForAllEarnersCall as alloy_sol_types::SolCall>::ReturnToken<'_>
            {
                ()
            }
        }
    ...
    const _: () = {
        ...
        impl createRewardsForAllSubmissionReturn {
            fn _tokenize(
                &self,
            ) -> <createRewardsForAllSubmissionCall as alloy_sol_types::SolCall>::ReturnToken<'_>
            {
                ()
            }
        }
    ...
    const _: () = {
        ...
        impl processClaimReturn {
            fn _tokenize(&self) -> <processClaimCall as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
    ...
    const _: () = {
        ...
        impl setDefaultOperatorSplitReturn {
            fn _tokenize(
                &self,
            ) -> <setDefaultOperatorSplitCall as alloy_sol_types::SolCall>::ReturnToken<'_>
            {
                ()
            }
        }
    ...
    const _: () = {
        ...
        impl setRewardsForAllSubmitterReturn {
            fn _tokenize(
                &self,
            ) -> <setRewardsForAllSubmitterCall as alloy_sol_types::SolCall>::ReturnToken<'_>
            {
                ()
            }
        }
    ...
    const _: () = {
        ...
        impl submitRootReturn {
            fn _tokenize(&self) -> <submitRootCall as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<IRewardsCoordinatorCalls>] = &[
                {
                    fn MAX_FUTURE_LENGTH(
                        ...
                        <MAX_FUTURE_LENGTHCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn claimerFor(
                        ...
                        <claimerForCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn activationDelay(
                        ...
                        <activationDelayCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn processClaim(
                        ...
                        <processClaimCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn submitRoot(
                        ...
                        <submitRootCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn processClaims(
                        ...
                        <processClaimsCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn getOperatorPISplit(
                        ...
                        <getOperatorPISplitCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                {
                    fn version(data: &[u8]) -> alloy_sol_types::Result<IRewardsCoordinatorCalls> {
                ...
                },
                {
                    fn setActivationDelay(
                        ...
                        <setActivationDelayCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn checkClaim(
                        ...
                        <checkClaimCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn setRewardsUpdater(
                        ...
                        <setRewardsUpdaterCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn cumulativeClaimed(
                        ...
                        <cumulativeClaimedCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn getOperatorSetSplit(
                        ...
                        <getOperatorSetSplitCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn setClaimerFor_0(
                        ...
                        <setClaimerFor_0Call as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn setOperatorPISplit(
                        ...
                        <setOperatorPISplitCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn MAX_REWARDS_DURATION(
                        ...
                        <MAX_REWARDS_DURATIONCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn setOperatorAVSSplit(
                        ...
                        <setOperatorAVSSplitCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn getOperatorAVSSplit(
                        ...
                        <getOperatorAVSSplitCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn getRootIndexFromHash(
                        ...
                        <getRootIndexFromHashCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn setClaimerFor_1(
                        ...
                        <setClaimerFor_1Call as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn setOperatorSetSplit(
                        ...
                        <setOperatorSetSplitCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn rewardsUpdater(
                        ...
                        <rewardsUpdaterCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
            ...
            >] = &[
                ...
                },
                {
                    fn claimerFor(
                        ...
                        <claimerForCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(data)
                            .map(IRewardsCoordinatorCalls::claimerFor)
                    }
                    claimerFor
                },
                ...
                },
                {
                    fn submitRoot(
                        ...
                        <submitRootCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(data)
                            .map(IRewardsCoordinatorCalls::submitRoot)
                    }
                    submitRoot
                },
                ...
                },
                {
                    fn checkClaim(
                        ...
                        <checkClaimCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(data)
                            .map(IRewardsCoordinatorCalls::checkClaim)
                    }
                    checkClaim
                },
            ...
            static DECODE_SHIMS: &[fn(
                ...
                },
                {
                    fn InvalidAddressZero(
                        ...
                        <InvalidAddressZero as alloy_sol_types::SolError>::abi_decode_raw(data)
                ...
                },
                {
                    fn AmountExceedsMax(
                        ...
                        <AmountExceedsMax as alloy_sol_types::SolError>::abi_decode_raw(data)
                ...
                },
                {
                    fn RootAlreadyActivated(
                        ...
                        <RootAlreadyActivated as alloy_sol_types::SolError>::abi_decode_raw(data)
                ...
                },
                {
                    fn DurationExceedsMax(
                        ...
                        <DurationExceedsMax as alloy_sol_types::SolError>::abi_decode_raw(data)
                ...
                },
                {
                    fn UnauthorizedCaller(
                        ...
                        <UnauthorizedCaller as alloy_sol_types::SolError>::abi_decode_raw(data)
                ...
                },
                {
                    fn InvalidEarnerLeafIndex(
                        ...
                        <InvalidEarnerLeafIndex as alloy_sol_types::SolError>::abi_decode_raw(data)
                ...
                },
                {
                    fn InvalidClaimProof(
                        ...
                        <InvalidClaimProof as alloy_sol_types::SolError>::abi_decode_raw(data)
                ...
                },
                {
                    fn PreviousSplitPending(
                        ...
                        <PreviousSplitPending as alloy_sol_types::SolError>::abi_decode_raw(data)
                ...
                },
                {
                    fn SplitExceedsMax(
                        ...
                        <SplitExceedsMax as alloy_sol_types::SolError>::abi_decode_raw(data)
                ...
                },
                {
                    fn InvalidRootIndex(
                        ...
                        <InvalidRootIndex as alloy_sol_types::SolError>::abi_decode_raw(data)
                ...
                },
                {
                    fn RootNotActivated(
                        ...
                        <RootNotActivated as alloy_sol_types::SolError>::abi_decode_raw(data)
                ...
                },
                {
                    fn InvalidTokenLeafIndex(
                        ...
                        <InvalidTokenLeafIndex as alloy_sol_types::SolError>::abi_decode_raw(data)
                ...
                },
                {
                    fn DurationIsZero(
                        ...
                        <DurationIsZero as alloy_sol_types::SolError>::abi_decode_raw(data)
                ...
                },
                {
                    fn InvalidEarner(
                        ...
                        <InvalidEarner as alloy_sol_types::SolError>::abi_decode_raw(data)
            ...
            >] = &[
                ...
                },
                {
                    fn AmountIsZero(
                        ...
                        <AmountIsZero as alloy_sol_types::SolError>::abi_decode_raw_validate(data)
                            .map(IRewardsCoordinatorErrors::AmountIsZero)
                    }
                    AmountIsZero
                },
                ...
                },
                {
                    fn DurationIsZero(
                        ...
                        <DurationIsZero as alloy_sol_types::SolError>::abi_decode_raw_validate(data)
                            .map(IRewardsCoordinatorErrors::DurationIsZero)
                    }
                    DurationIsZero
                },
                ...
                },
                {
                    fn InvalidEarner(
                        ...
                        <InvalidEarner as alloy_sol_types::SolError>::abi_decode_raw_validate(data)
                            .map(IRewardsCoordinatorErrors::InvalidEarner)
                    }
                    InvalidEarner
                },
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IRewardsCoordinatorInstance<P, N>>>
    {
        IRewardsCoordinatorInstance::<P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IRewardsCoordinatorInstance::<P, N>::deploy_builder(provider)
    }
        ...
        IRewardsCoordinatorInstance<P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IRewardsCoordinatorInstance<P, N>> {
        ...
        IRewardsCoordinatorInstance<P, N>
    {
        ...
        pub fn currRewardsCalculationEndTimestamp(
            &self,
        ) -> alloy_contract::SolCallBuilder<&P, currRewardsCalculationEndTimestampCall, N> {
        ...
        pub fn getCurrentClaimableDistributionRoot(
            &self,
        ) -> alloy_contract::SolCallBuilder<&P, getCurrentClaimableDistributionRootCall, N>
        {
        ...
        pub fn rewardsUpdater(&self) -> alloy_contract::SolCallBuilder<&P, rewardsUpdaterCall, N> {
        ...
        IRewardsCoordinatorInstance<P, N>
    {
        ...
        pub fn ClaimerForSet_filter(&self) -> alloy_contract::Event<&P, ClaimerForSet, N> {
        ...
        pub fn OperatorDirectedOperatorSetRewardsSubmissionCreated_filter(
            &self,
        ) -> alloy_contract::Event<&P, OperatorDirectedOperatorSetRewardsSubmissionCreated, N>
        {
        ...
        pub fn RewardsUpdaterSet_filter(&self) -> alloy_contract::Event<&P, RewardsUpdaterSet, N> {
