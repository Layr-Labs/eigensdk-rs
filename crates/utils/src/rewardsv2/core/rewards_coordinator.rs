...
pub mod RewardsCoordinator {
    ...
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    pub struct claimerForCall(pub alloy::sol_types::private::Address);
    #[derive(serde::Serialize, serde::Deserialize, Default, Debug, PartialEq, Eq, Hash)]
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for getCurrentClaimableDistributionRootCall {
            ...
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                (
                    <IRewardsCoordinator::DistributionRoot as alloy_sol_types::SolType>::tokenize(
                        ret,
                    ),
                )
            }
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for isOperatorDirectedAVSRewardsSubmissionHashCall {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<'_> as alloy_sol_types::SolType>::abi_decode_sequence(data).map(
                    |r| {
                        let r: isOperatorDirectedAVSRewardsSubmissionHashReturn = r.into();
                        r._0
                    },
                )
            }
    ...
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    pub struct isRewardsForAllSubmitterCall(pub alloy::sol_types::private::Address);
    #[derive(serde::Serialize, serde::Deserialize, Default, Debug, PartialEq, Eq, Hash)]
    ...
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    pub struct submissionNonceCall(pub alloy::sol_types::private::Address);
    #[derive(serde::Serialize, serde::Deserialize, Default, Debug, PartialEq, Eq, Hash)]
    ...
    impl alloy_sol_types::SolInterface for RewardsCoordinatorCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(
                ...
                {
                    fn pause(data: &[u8]) -> alloy_sol_types::Result<RewardsCoordinatorCalls> {
                ...
                {
                    fn claimerFor(data: &[u8]) -> alloy_sol_types::Result<RewardsCoordinatorCalls> {
                ...
                {
                    fn submitRoot(data: &[u8]) -> alloy_sol_types::Result<RewardsCoordinatorCalls> {
                ...
                {
                    fn pauseAll(data: &[u8]) -> alloy_sol_types::Result<RewardsCoordinatorCalls> {
                ...
                {
                    fn paused_0(data: &[u8]) -> alloy_sol_types::Result<RewardsCoordinatorCalls> {
                ...
                {
                    fn paused_1(data: &[u8]) -> alloy_sol_types::Result<RewardsCoordinatorCalls> {
                ...
                {
                    fn checkClaim(data: &[u8]) -> alloy_sol_types::Result<RewardsCoordinatorCalls> {
                ...
                {
                    fn owner(data: &[u8]) -> alloy_sol_types::Result<RewardsCoordinatorCalls> {
                ...
                },
                {
                    fn submissionNonce(
                        ...
                        <submissionNonceCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                {
                    fn initialize(data: &[u8]) -> alloy_sol_types::Result<RewardsCoordinatorCalls> {
                ...
                {
                    fn unpause(data: &[u8]) -> alloy_sol_types::Result<RewardsCoordinatorCalls> {
    ...
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<RewardsCoordinatorInstance<P, N>>>
    {
        RewardsCoordinatorInstance::<P, N>::deploy(
            provider,
            _delegationManager,
            _strategyManager,
    ...
    >(
        ...
        RewardsCoordinatorInstance::<P, N>::deploy_builder(
            provider,
            _delegationManager,
            _strategyManager,
            _CALCULATION_INTERVAL_SECONDS,
        ...
        RewardsCoordinatorInstance<P, N>
    {
        ...
        pub fn isOperatorDirectedAVSRewardsSubmissionHash(
            ...
            _0: alloy::sol_types::private::Address,
            _1: alloy::sol_types::private::FixedBytes<32>,
        ) -> alloy_contract::SolCallBuilder<&P, isOperatorDirectedAVSRewardsSubmissionHashCall, N>
        {
        ...
        pub fn isRewardsSubmissionForAllEarnersHash(
            ...
            _0: alloy::sol_types::private::Address,
            _1: alloy::sol_types::private::FixedBytes<32>,
        ) -> alloy_contract::SolCallBuilder<&P, isRewardsSubmissionForAllEarnersHashCall, N>
        {
