...
pub mod IEigenPodManager {
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for podOwnerSharesCall {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<'_> as alloy_sol_types::SolType>::abi_decode_sequence(data).map(
                    |r| {
                        let r: podOwnerSharesReturn = r.into();
                        r._0
                    },
                )
            }
            ...
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IEigenPodManagerCalls>] = &[
                ...
                },
                {
                    fn podOwnerShares(
                        ...
                        <podOwnerSharesCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                {
                    fn slasher(data: &[u8]) -> alloy_sol_types::Result<IEigenPodManagerCalls> {
                ...
                {
                    fn removeShares(data: &[u8]) -> alloy_sol_types::Result<IEigenPodManagerCalls> {
            ...
            >] = &[
                ...
                },
                {
                    fn podOwnerShares(
                        ...
                        <podOwnerSharesCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                            data,
                        )
                        .map(IEigenPodManagerCalls::podOwnerShares)
                    }
        ...
        IEigenPodManagerInstance<P, N>
    {
        ...
        pub fn podOwnerShares(
            &self,
            podOwner: alloy::sol_types::private::Address,
        ) -> alloy_contract::SolCallBuilder<&P, podOwnerSharesCall, N> {
