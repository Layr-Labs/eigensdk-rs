...
pub mod IIndexRegistry {
    ...
    >(
        ...
        provider: P,
    ) -> IIndexRegistryInstance<P, N> {
        IIndexRegistryInstance::<P, N>::new(address, provider)
    }
    ...
    #[derive(Clone)]
    pub struct IIndexRegistryInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IIndexRegistryInstance<P, N> {
        #[inline]
    ...
    impl<P: ::core::clone::Clone, N> IIndexRegistryInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IIndexRegistryInstance<P, N> {
...
pub mod IndexRegistry {
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for getLatestOperatorUpdateCall {
            ...
            type Token<'a> = <Self::Parameters<'a> as alloy_sol_types::SolType>::Token<'a>;
            type Return = <IIndexRegistry::OperatorUpdate as alloy::sol_types::SolType>::RustType;
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                (<IIndexRegistry::OperatorUpdate as alloy_sol_types::SolType>::tokenize(ret),)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<'_> as alloy_sol_types::SolType>::abi_decode_sequence(data).map(
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for getLatestQuorumUpdateCall {
            ...
            type Token<'a> = <Self::Parameters<'a> as alloy_sol_types::SolType>::Token<'a>;
            type Return = <IIndexRegistry::QuorumUpdate as alloy::sol_types::SolType>::RustType;
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                (<IIndexRegistry::QuorumUpdate as alloy_sol_types::SolType>::tokenize(ret),)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<'_> as alloy_sol_types::SolType>::abi_decode_sequence(data).map(
    ...
    {
        IndexRegistryInstance::<P, N>::deploy(provider, _registryCoordinator)
    }
    ...
    >(
        ...
        IndexRegistryInstance::<P, N>::deploy_builder(provider, _registryCoordinator)
    }
