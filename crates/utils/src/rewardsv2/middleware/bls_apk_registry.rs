...
pub mod BLSApkRegistry {
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for getApkUpdateAtIndexCall {
            ...
            type Token<'a> = <Self::Parameters<'a> as alloy_sol_types::SolType>::Token<'a>;
            type Return = <IBLSApkRegistry::ApkUpdate as alloy::sol_types::SolType>::RustType;
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                (<IBLSApkRegistry::ApkUpdate as alloy_sol_types::SolType>::tokenize(ret),)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<'_> as alloy_sol_types::SolType>::abi_decode_sequence(data).map(
    ...
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    pub struct operatorToPubkeyCall(pub alloy::sol_types::private::Address);
    #[derive(serde::Serialize, serde::Deserialize, Default, Debug, PartialEq, Eq, Hash)]
    ...
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    pub struct operatorToPubkeyHashCall(pub alloy::sol_types::private::Address);
    #[derive(serde::Serialize, serde::Deserialize, Default, Debug, PartialEq, Eq, Hash)]
    ...
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    pub struct pubkeyHashToOperatorCall(pub alloy::sol_types::private::FixedBytes<32>);
    #[derive(serde::Serialize, serde::Deserialize, Default, Debug, PartialEq, Eq, Hash)]
    ...
    {
        BLSApkRegistryInstance::<P, N>::deploy(provider, _registryCoordinator)
    }
    ...
    >(
        ...
        BLSApkRegistryInstance::<P, N>::deploy_builder(provider, _registryCoordinator)
    }
        ...
        BLSApkRegistryInstance<P, N>
    {
        ...
        pub fn currentApk(&self, _0: u8) -> alloy_contract::SolCallBuilder<&P, currentApkCall, N> {
