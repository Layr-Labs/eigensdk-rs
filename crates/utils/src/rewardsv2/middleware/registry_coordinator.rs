...
pub mod IBLSApkRegistry {
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IBLSApkRegistryInstance<P, N> {
        IBLSApkRegistryInstance::<P, N>::new(address, provider)
    }
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IBLSApkRegistryInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IBLSApkRegistryInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    ...
    impl<P: ::core::clone::Clone, N> IBLSApkRegistryInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IBLSApkRegistryInstance<P, N> {
...
pub mod IRegistryCoordinator {
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IRegistryCoordinatorInstance<P, N> {
        IRegistryCoordinatorInstance::<P, N>::new(address, provider)
    }
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IRegistryCoordinatorInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IRegistryCoordinatorInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    ...
    impl<P: ::core::clone::Clone, N> IRegistryCoordinatorInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IRegistryCoordinatorInstance<P, N> {
...
pub mod RegistryCoordinator {
    ...
    const _: () = {
        ...
        impl createQuorumReturn {
            fn _tokenize(&self) -> <createQuorumCall as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for createQuorumCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                createQuorumReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for getOperatorCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                (<IRegistryCoordinator::OperatorInfo as alloy_sol_types::SolType>::tokenize(ret),)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<'_> as alloy_sol_types::SolType>::abi_decode_sequence(data).map(
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for getQuorumBitmapUpdateByIndexCall {
            ...
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                (
                    <IRegistryCoordinator::QuorumBitmapUpdate as alloy_sol_types::SolType>::tokenize(
                        ret,
                    ),
                )
            }
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for numRegistriesCall {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<'_> as alloy_sol_types::SolType>::abi_decode_sequence(data).map(
                    |r| {
                        let r: numRegistriesReturn = r.into();
                        r._0
                    },
                )
            }
    ...
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    pub struct registriesCall(pub alloy::sol_types::private::primitives::aliases::U256);
    #[derive(serde::Serialize, serde::Deserialize, Default, Debug, PartialEq, Eq, Hash)]
            ...
            static DECODE_SHIMS: &[fn(
                ...
                },
                {
                    fn registries(
                        ...
                        <registriesCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn numRegistries(
                        ...
                        <numRegistriesCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn createQuorum(
                        ...
                        <createQuorumCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
            ...
            >] = &[
                ...
                },
                {
                    fn registries(
                        ...
                        <registriesCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(data)
                            .map(RegistryCoordinatorCalls::registries)
                    }
                    registries
                },
                ...
                },
                {
                    fn numRegistries(
                        ...
                        <numRegistriesCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                            data,
                        )
                        .map(RegistryCoordinatorCalls::numRegistries)
                    }
                ...
                },
                {
                    fn createQuorum(
                        ...
                        <createQuorumCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                            data,
                        )
                        .map(RegistryCoordinatorCalls::createQuorum)
                    }
    ...
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<RegistryCoordinatorInstance<P, N>>>
    {
        RegistryCoordinatorInstance::<P, N>::deploy(
            provider,
            _serviceManager,
            _stakeRegistry,
            _blsApkRegistry,
    ...
    >(
        ...
        RegistryCoordinatorInstance::<P, N>::deploy_builder(
            provider,
            _serviceManager,
            _stakeRegistry,
            _blsApkRegistry,
        ...
        RegistryCoordinatorInstance<P, N>
    {
        ...
        pub async fn deploy(
            ...
            _indexRegistry: alloy::sol_types::private::Address,
            _socketRegistry: alloy::sol_types::private::Address,
        ) -> alloy_contract::Result<RegistryCoordinatorInstance<P, N>> {
        ...
        RegistryCoordinatorInstance<P, N>
    {
        ...
        pub fn createQuorum(
            ...
            strategyParams: alloy::sol_types::private::Vec<
                <IStakeRegistry::StrategyParams as alloy::sol_types::SolType>::RustType,
            >,
        ) -> alloy_contract::SolCallBuilder<&P, createQuorumCall, N> {
        ...
        pub fn numRegistries(&self) -> alloy_contract::SolCallBuilder<&P, numRegistriesCall, N> {
        ...
        ) -> alloy_contract::SolCallBuilder<&P, registriesCall, N> {
