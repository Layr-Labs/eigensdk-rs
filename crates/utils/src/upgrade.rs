...
pub mod Upgrade {
    ...
    impl alloy_sol_types::SolInterface for UpgradeCalls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<UpgradeCalls>] = &[
                {
                ...
                {
                    fn run(data: &[u8], validate: bool) -> alloy_sol_types::Result<UpgradeCalls> {
                ...
                {
                    fn EIGEN(data: &[u8], validate: bool) -> alloy_sol_types::Result<UpgradeCalls> {
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<UpgradeInstance<T, P, N>>>
    {
        ...
        > UpgradeInstance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<UpgradeInstance<T, P, N>> {
