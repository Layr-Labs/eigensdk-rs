...
pub mod IPermissionController {
    ...
    ///Container for all the [`IPermissionController`](self) function calls.
    pub enum IPermissionControllerCalls {
    ...
    #[automatically_derived]
    impl IPermissionControllerCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IPermissionControllerCalls {
        const NAME: &'static str = "IPermissionControllerCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<IPermissionControllerCalls>] = &[
                {
                    fn removeAppointee(
                        data: &[u8],
                        validate: bool,
                        ...
                        .map(IPermissionControllerCalls::removeAppointee)
                    }
                    removeAppointee
                },
                {
                    fn removeAdmin(
                        ...
                        .map(IPermissionControllerCalls::removeAdmin)
                    }
                    removeAdmin
                },
                {
                    fn removePendingAdmin(
                        ...
                        .map(IPermissionControllerCalls::removePendingAdmin)
                    }
                    removePendingAdmin
                },
                {
                    fn acceptAdmin(
                        ...
                        .map(IPermissionControllerCalls::acceptAdmin)
                    }
                    acceptAdmin
                },
                {
                    fn getPendingAdmins(
                        ...
                        .map(IPermissionControllerCalls::getPendingAdmins)
                    }
                    getPendingAdmins
                },
                {
                    fn getAppointeePermissions(
                        ...
                        .map(IPermissionControllerCalls::getAppointeePermissions)
                    }
                ...
                },
                {
                    fn isAdmin(
                        ...
                        <isAdminCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IPermissionControllerCalls::isAdmin)
                    }
                    isAdmin
                },
                {
                    fn setAppointee(
                        ...
                        .map(IPermissionControllerCalls::setAppointee)
                    }
                    setAppointee
                },
                {
                    fn getAdmins(
                        ...
                        <getAdminsCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IPermissionControllerCalls::getAdmins)
                    }
                    getAdmins
                },
                {
                    fn isPendingAdmin(
                        ...
                        .map(IPermissionControllerCalls::isPendingAdmin)
                    }
                    isPendingAdmin
                },
                {
                    fn canCall(
                        ...
                        <canCallCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(IPermissionControllerCalls::canCall)
                    }
                    canCall
                },
                {
                    fn addPendingAdmin(
                        ...
                        .map(IPermissionControllerCalls::addPendingAdmin)
                    }
                    addPendingAdmin
                },
                {
                    fn getAppointees(
                        ...
                        .map(IPermissionControllerCalls::getAppointees)
                    }
                    getAppointees
                },
            ];
    ...
    ///Container for all the [`IPermissionController`](self) custom errors.
    pub enum IPermissionControllerErrors {
    ...
    #[automatically_derived]
    impl IPermissionControllerErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IPermissionControllerErrors {
        const NAME: &'static str = "IPermissionControllerErrors";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<IPermissionControllerErrors>] = &[
                {
                    fn AppointeeNotSet(
                        data: &[u8],
                        validate: bool,
                        ...
                        .map(IPermissionControllerErrors::AppointeeNotSet)
                    }
                    AppointeeNotSet
                },
                {
                    fn AdminAlreadyPending(
                        ...
                        .map(IPermissionControllerErrors::AdminAlreadyPending)
                    }
                    AdminAlreadyPending
                },
                {
                    fn NotAdmin(
                        ...
                        <NotAdmin as alloy_sol_types::SolError>::abi_decode_raw(data, validate)
                            .map(IPermissionControllerErrors::NotAdmin)
                    }
                    NotAdmin
                },
                {
                    fn CannotHaveZeroAdmins(
                        ...
                        .map(IPermissionControllerErrors::CannotHaveZeroAdmins)
                    }
                ...
                },
                {
                    fn AdminAlreadySet(
                        ...
                        .map(IPermissionControllerErrors::AdminAlreadySet)
                    }
                    AdminAlreadySet
                },
                {
                    fn AppointeeAlreadySet(
                        ...
                        .map(IPermissionControllerErrors::AppointeeAlreadySet)
                    }
                    AppointeeAlreadySet
                },
                {
                    fn AdminNotPending(
                        ...
                        .map(IPermissionControllerErrors::AdminNotPending)
                    }
                    AdminNotPending
                },
                {
                    fn AdminNotSet(
                        ...
                        <AdminNotSet as alloy_sol_types::SolError>::abi_decode_raw(data, validate)
                            .map(IPermissionControllerErrors::AdminNotSet)
                    }
                    AdminNotSet
                },
            ];
    ...
    ///Container for all the [`IPermissionController`](self) events.
    pub enum IPermissionControllerEvents {
    ...
    #[automatically_derived]
    impl IPermissionControllerEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IPermissionControllerEvents {
        const NAME: &'static str = "IPermissionControllerEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IPermissionControllerEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`IPermissionController`](self) contract instance.

    See the [wrapper's documentation](`IPermissionControllerInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IPermissionControllerInstance<T, P, N> {
        IPermissionControllerInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        ...
        Output = alloy_contract::Result<IPermissionControllerInstance<T, P, N>>,
    > {
        IPermissionControllerInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IPermissionControllerInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IPermissionController`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`IPermissionController`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    #[derive(Clone)]
    pub struct IPermissionControllerInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IPermissionControllerInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IPermissionControllerInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        > IPermissionControllerInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IPermissionControllerInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> IPermissionControllerInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IPermissionControllerInstance<T, P, N> {
            IPermissionControllerInstance {
