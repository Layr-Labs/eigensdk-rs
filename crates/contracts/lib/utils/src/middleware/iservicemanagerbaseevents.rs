...
```*/
    ...
    pub struct AVSRewardsSubmissionCreated {
        ...
        #[allow(missing_docs)]
        pub rewardsSubmission: <IRewardsCoordinator::RewardsSubmission as alloy::sol_types::SolType>::RustType,
    }
    #[allow(
        non_camel_case_types,
        non_snake_case,
...
```*/
    ...
    ///Container for all the [`IServiceManagerBaseEvents`](self) events.
    pub enum IServiceManagerBaseEventsEvents {
    ...
    #[automatically_derived]
    impl IServiceManagerBaseEventsEvents {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IServiceManagerBaseEventsEvents {
        const NAME: &'static str = "IServiceManagerBaseEventsEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IServiceManagerBaseEventsEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`IServiceManagerBaseEvents`](self) contract instance.

See the [wrapper's documentation](`IServiceManagerBaseEventsInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IServiceManagerBaseEventsInstance<T, P, N> {
        IServiceManagerBaseEventsInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IServiceManagerBaseEventsInstance<T, P, N>>,
    > {
        IServiceManagerBaseEventsInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IServiceManagerBaseEventsInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IServiceManagerBaseEvents`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IServiceManagerBaseEvents`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IServiceManagerBaseEventsInstance<
        T,
        P,
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IServiceManagerBaseEventsInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IServiceManagerBaseEventsInstance")
                .field(&self.address)
                .finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IServiceManagerBaseEventsInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IServiceManagerBaseEventsInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IServiceManagerBaseEventsInstance<T, P, N> {
            IServiceManagerBaseEventsInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
